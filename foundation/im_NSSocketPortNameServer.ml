...
class virtual methods = object (self)
  ...
  method portForName_host_nameServerPortNumber  (name : [`NSString] Objc.t) (host : [`NSString] Objc.t) (portNumber : int) =
    let sel, args = (
      Objc.arg name "portForName" make_pointer_from_object
      ++ Objc.arg host "host" make_pointer_from_object
      ++ Objc.arg portNumber "nameServerPortNumber" make_int
    ) ([],[]) in
      ((get_pointer (Objc.invoke Objc.tag_pointer self#repr (Selector.find_list sel) args)
       : [`NSPort] Objc.id))
  method registerPort_name_nameServerPortNumber  (port : [`NSPort] Objc.t) (name : [`NSString] Objc.t) (portNumber : int) =
    let sel, args = (
      Objc.arg port "registerPort" make_pointer_from_object
      ++ Objc.arg name "name" make_pointer_from_object
      ++ Objc.arg portNumber "nameServerPortNumber" make_int
