...
let _ = init()
let make_NSObject_of_NSDictionary (o : [`NSDictionary] nativeNSObject) = (Obj.magic o : [`NSObject] nativeNSObject)
...
(* methods for category NSDictionaryCreation *)
   method dictionary =
     (get_pointer (Objc.invoke Objc.tag_pointer repr (Selector.find "dictionary:")[]) : [`NSDictionary] Objc.nativeNSObject)
   method dictionaryWithContentsOfFile (path : [`NSString] Objc.t) =
     (get_pointer (Objc.invoke Objc.tag_pointer repr (Selector.find "dictionaryWithContentsOfFile:")[make_pointer_from_object path]) : [`NSDictionary] Objc.nativeNSObject)
   method dictionaryWithContentsOfURL (url : [`NSURL] Objc.t) =
     (get_pointer (Objc.invoke Objc.tag_pointer repr (Selector.find "dictionaryWithContentsOfURL:")[make_pointer_from_object url]) : [`NSDictionary] Objc.nativeNSObject)
   ...
   method dictionaryWithDictionary (dict : [`NSDictionary] Objc.t) =
     (get_pointer (Objc.invoke Objc.tag_pointer repr (Selector.find "dictionaryWithDictionary:")[make_pointer_from_object dict]) : [`NSDictionary] Objc.nativeNSObject)
...
class native_NSDictionary = fun (o : [`NSDictionary] nativeNSObject) -> object (self)
   inherit native_NSObject (make_NSObject_of_NSDictionary o) as super
(* methods for category NSDictionaryCreation *)
...
(* methods for category NSExtendedDictionary *)
   ...
   method allKeysForObject (anObject : [`NSObject] Objc.t) =
     (get_pointer (Objc.invoke Objc.tag_pointer repr (Selector.find "allKeysForObject:")[make_pointer_from_object anObject]) : [`NSArray] Objc.nativeNSObject)
   method allValues =
     (get_pointer (Objc.invoke Objc.tag_pointer repr (Selector.find "allValues:")[]) : [`NSArray] Objc.nativeNSObject)
   method description =
   ...
   method descriptionInStringsFileFormat =
     (get_pointer (Objc.invoke Objc.tag_pointer repr (Selector.find "descriptionInStringsFileFormat:")[]) : [`NSString] Objc.nativeNSObject)
   ...
   method isEqualToDictionary (otherDictionary : [`NSDictionary] Objc.t) =
     (get_bool (Objc.invoke Objc.tag_bool repr (Selector.find "isEqualToDictionary:")[make_pointer_from_object otherDictionary]) : bool)
   ...
   method keysSortedByValueUsingSelector (comparator : selector) =
     (get_pointer (Objc.invoke Objc.tag_pointer repr (Selector.find "keysSortedByValueUsingSelector:")[make_selector comparator]) : [`NSArray] Objc.nativeNSObject)
   method count =
     (get_int (Objc.invoke Objc.tag_int repr (Selector.find "count:")[]) : int)
   method keyEnumerator =
     (get_pointer (Objc.invoke Objc.tag_pointer repr (Selector.find "keyEnumerator:")[]) : [`NSEnumerator] Objc.nativeNSObject)
   method objectForKey (aKey : [`NSObject] Objc.t) =
     (get_pointer (Objc.invoke Objc.tag_pointer repr (Selector.find "objectForKey:")[make_pointer_from_object aKey]) : [`NSObject] Objc.nativeNSObject)
end
let make_NSDictionary_of_NSMutableDictionary (o : [`NSMutableDictionary] nativeNSObject) = (Obj.magic o : [`NSDictionary] nativeNSObject)
...
(* methods for category NSMutableDictionaryCreation *)
   method dictionaryWithCapacity (numItems : int) =
     (get_pointer (Objc.invoke Objc.tag_pointer repr (Selector.find "dictionaryWithCapacity:")[make_int numItems]) : [`NSMutableDictionary] Objc.nativeNSObject)
...
class native_NSMutableDictionary = fun (o : [`NSMutableDictionary] nativeNSObject) -> object (self)
   inherit native_NSDictionary (make_NSDictionary_of_NSMutableDictionary o) as super
(* methods for category NSMutableDictionaryCreation *)
...
(* methods for category NSExtendedMutableDictionary *)
   method addEntriesFromDictionary (otherDictionary : [`NSDictionary] Objc.t) =
     (get_unit (Objc.invoke Objc.tag_unit repr (Selector.find "addEntriesFromDictionary:")[make_pointer_from_object otherDictionary]) : unit)
   ...
   method removeObjectsForKeys (keyArray : [`NSArray] Objc.t) =
     (get_unit (Objc.invoke Objc.tag_unit repr (Selector.find "removeObjectsForKeys:")[make_pointer_from_object keyArray]) : unit)
   method setDictionary (otherDictionary : [`NSDictionary] Objc.t) =
     (get_unit (Objc.invoke Objc.tag_unit repr (Selector.find "setDictionary:")[make_pointer_from_object otherDictionary]) : unit)
   method removeObjectForKey (aKey : [`NSObject] Objc.t) =
     (get_unit (Objc.invoke Objc.tag_unit repr (Selector.find "removeObjectForKey:")[make_pointer_from_object aKey]) : unit)
