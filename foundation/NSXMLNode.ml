...
let _ = init()
let make_NSObject_of_NSXMLNode (o : [`NSXMLNode] nativeNSObject) = (Obj.magic o : [`NSObject] nativeNSObject)
(* Class object for NSXMLNode *)
let class_NSXMLNode = object
   val repr = Classes.find "NSXMLNode"
   method _new = (Objc.objcnew repr : [`NSXMLNode] nativeNSObject)
   method _alloc = (Objc.objcalloc repr : [`NSXMLNode] nativeNSObject)
   method document =
     (get_pointer (Objc.invoke Objc.tag_pointer repr (Selector.find "document:")[]) : [`NSXMLNode] Objc.nativeNSObject)
   method documentWithRootElement (element : [`NSXMLElement] Objc.t) =
     (get_pointer (Objc.invoke Objc.tag_pointer repr (Selector.find "documentWithRootElement:")[make_pointer_from_object element]) : [`NSXMLNode] Objc.nativeNSObject)
   ...
   method commentWithStringValue (stringValue : [`NSString] Objc.t) =
     (get_pointer (Objc.invoke Objc.tag_pointer repr (Selector.find "commentWithStringValue:")[make_pointer_from_object stringValue]) : [`NSXMLNode] Objc.nativeNSObject)
   method textWithStringValue (stringValue : [`NSString] Objc.t) =
     (get_pointer (Objc.invoke Objc.tag_pointer repr (Selector.find "textWithStringValue:")[make_pointer_from_object stringValue]) : [`NSXMLNode] Objc.nativeNSObject)
   method l_DTDNodeWithXMLString (string : [`NSString] Objc.t) =
     (get_pointer (Objc.invoke Objc.tag_pointer repr (Selector.find "l_DTDNodeWithXMLString:")[make_pointer_from_object string]) : [`NSXMLNode] Objc.nativeNSObject)
   method localNameForName (name : [`NSString] Objc.t) =
     (get_pointer (Objc.invoke Objc.tag_pointer repr (Selector.find "localNameForName:")[make_pointer_from_object name]) : [`NSString] Objc.nativeNSObject)
   method prefixForName (name : [`NSString] Objc.t) =
     (get_pointer (Objc.invoke Objc.tag_pointer repr (Selector.find "prefixForName:")[make_pointer_from_object name]) : [`NSString] Objc.nativeNSObject)
   method predefinedNamespaceForPrefix (name : [`NSString] Objc.t) =
     (get_pointer (Objc.invoke Objc.tag_pointer repr (Selector.find "predefinedNamespaceForPrefix:")[make_pointer_from_object name]) : [`NSXMLNode] Objc.nativeNSObject)
end
(* Encapsulation for native instance of NSXMLNode *)
class native_NSXMLNode = fun (o : [`NSXMLNode] nativeNSObject) -> object (self)
   inherit native_NSObject (make_NSObject_of_NSXMLNode o) as super
   ...
   method kind =
     (get_int (Objc.invoke Objc.tag_int repr (Selector.find "kind:")[]) : int)
   ...
   method setObjectValue (value : [`NSObject] Objc.t) =
     (get_unit (Objc.invoke Objc.tag_unit repr (Selector.find "setObjectValue:")[make_pointer_from_object value]) : unit)
   method objectValue =
   ...
   method rootDocument =
     (get_pointer (Objc.invoke Objc.tag_pointer repr (Selector.find "rootDocument:")[]) : [`NSXMLDocument] Objc.nativeNSObject)
   method parent =
     (get_pointer (Objc.invoke Objc.tag_pointer repr (Selector.find "parent:")[]) : [`NSXMLNode] Objc.nativeNSObject)
   method childCount =
     (get_int (Objc.invoke Objc.tag_int repr (Selector.find "childCount:")[]) : int)
   method children =
     (get_pointer (Objc.invoke Objc.tag_pointer repr (Selector.find "children:")[]) : [`NSArray] Objc.nativeNSObject)
   method childAtIndex (index : int) =
     (get_pointer (Objc.invoke Objc.tag_pointer repr (Selector.find "childAtIndex:")[make_int index]) : [`NSXMLNode] Objc.nativeNSObject)
   method previousSibling =
     (get_pointer (Objc.invoke Objc.tag_pointer repr (Selector.find "previousSibling:")[]) : [`NSXMLNode] Objc.nativeNSObject)
   method nextSibling =
     (get_pointer (Objc.invoke Objc.tag_pointer repr (Selector.find "nextSibling:")[]) : [`NSXMLNode] Objc.nativeNSObject)
   method previousNode =
     (get_pointer (Objc.invoke Objc.tag_pointer repr (Selector.find "previousNode:")[]) : [`NSXMLNode] Objc.nativeNSObject)
   method nextNode =
     (get_pointer (Objc.invoke Objc.tag_pointer repr (Selector.find "nextNode:")[]) : [`NSXMLNode] Objc.nativeNSObject)
   method detach =
     (get_unit (Objc.invoke Objc.tag_unit repr (Selector.find "detach:")[]) : unit)
   method l_XPath =
     (get_pointer (Objc.invoke Objc.tag_pointer repr (Selector.find "l_XPath:")[]) : [`NSString] Objc.nativeNSObject)
   method localName =
     (get_pointer (Objc.invoke Objc.tag_pointer repr (Selector.find "localName:")[]) : [`NSString] Objc.nativeNSObject)
   method prefix =
     (get_pointer (Objc.invoke Objc.tag_pointer repr (Selector.find "prefix:")[]) : [`NSString] Objc.nativeNSObject)
   method setURI (_URI : [`NSString] Objc.t) =
     (get_unit (Objc.invoke Objc.tag_unit repr (Selector.find "setURI:")[make_pointer_from_object _URI]) : unit)
   method l_URI =
     (get_pointer (Objc.invoke Objc.tag_pointer repr (Selector.find "l_URI:")[]) : [`NSString] Objc.nativeNSObject)
   method description =
     (get_pointer (Objc.invoke Objc.tag_pointer repr (Selector.find "description:")[]) : [`NSString] Objc.nativeNSObject)
   method l_XMLString =
     (get_pointer (Objc.invoke Objc.tag_pointer repr (Selector.find "l_XMLString:")[]) : [`NSString] Objc.nativeNSObject)
   method l_XMLStringWithOptions (options : int) =
     (get_pointer (Objc.invoke Objc.tag_pointer repr (Selector.find "l_XMLStringWithOptions:")[make_int options]) : [`NSString] Objc.nativeNSObject)
   method canonicalXMLStringPreservingComments (comments : bool) =
     (get_pointer (Objc.invoke Objc.tag_pointer repr (Selector.find "canonicalXMLStringPreservingComments:")[make_bool comments]) : [`NSString] Objc.nativeNSObject)
