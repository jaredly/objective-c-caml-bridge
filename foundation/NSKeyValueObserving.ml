...
(* methods for category NSKeyValueObservingCustomization *)
   method automaticallyNotifiesObserversForKey (key : [`NSString] Objc.t) =
     (get_pointer (Objc.invoke Objc.tag_pointer o (Selector.find "automaticallyNotifiesObserversForKey:")[make_pointer_from_object key]) : [`NSObject] Objc.nativeNSObject)
...
(* methods for category NSKeyValueObservingCustomization *)
   method setObservationInfo (observationInfo : [`void] Objc.t) =
     (get_unit (Objc.invoke Objc.tag_unit o (Selector.find "setObservationInfo:")[make_pointer_from_object observationInfo]) : unit)
   method observationInfo =
     (get_pointer (Objc.invoke Objc.tag_pointer o (Selector.find "observationInfo:")[]) : [`void] Objc.nativeNSObject)
(* methods for category NSKeyValueObserverNotification *)
