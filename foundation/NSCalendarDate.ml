...
let _ = init()
let make_NSDate_of_NSCalendarDate (o : [`NSCalendarDate] nativeNSObject) = (Obj.magic o : [`NSDate] nativeNSObject)
(* Class object for NSCalendarDate *)
let class_NSCalendarDate = object
   val repr = Classes.find "NSCalendarDate"
   method _new = (Objc.objcnew repr : [`NSCalendarDate] nativeNSObject)
   method _alloc = (Objc.objcalloc repr : [`NSCalendarDate] nativeNSObject)
   method dateWithYear  ~month:(month : int ) ~day:(day : int ) ~hour:(hour : int ) ~minute:(minute : int ) ~second:(second : int ) ~timeZone:(aTimeZone : [`NSTimeZone] Objc.t ) (year : int) =
     let sel, args = (
       ...
       (get_pointer (Objc.invoke Objc.tag_pointer repr (Selector.find_list sel) args) : [`NSCalendarDate] Objc.nativeNSObject)
   ...
   method dateWithString  ~calendarFormat:(format : [`NSString] Objc.t ) ?locale:(dict : [`NSDictionary] Objc.t option) (description : [`NSString] Objc.t) =
     let sel, args = (
       ...
       (get_pointer (Objc.invoke Objc.tag_pointer repr (Selector.find_list sel) args) : [`NSCalendarDate] Objc.nativeNSObject)
   method calendarDate =
     (get_pointer (Objc.invoke Objc.tag_pointer repr (Selector.find "calendarDate:")[]) : [`NSCalendarDate] Objc.nativeNSObject)
end
...
class native_NSCalendarDate = fun (o : [`NSCalendarDate] nativeNSObject) -> object (self)
   inherit native_NSDate (make_NSDate_of_NSCalendarDate o) as super
   ...
   method setTimeZone (aTimeZone : [`NSTimeZone] Objc.t) =
     (get_unit (Objc.invoke Objc.tag_unit repr (Selector.find "setTimeZone:")[make_pointer_from_object aTimeZone]) : unit)
   method calendarFormat =
     (get_pointer (Objc.invoke Objc.tag_pointer repr (Selector.find "calendarFormat:")[]) : [`NSString] Objc.nativeNSObject)
   method setCalendarFormat (format : [`NSString] Objc.t) =
     (get_unit (Objc.invoke Objc.tag_unit repr (Selector.find "setCalendarFormat:")[make_pointer_from_object format]) : unit)
   method yearOfCommonEra =
     (get_int (Objc.invoke Objc.tag_int repr (Selector.find "yearOfCommonEra:")[]) : int)
   method monthOfYear =
     (get_int (Objc.invoke Objc.tag_int repr (Selector.find "monthOfYear:")[]) : int)
   method dayOfMonth =
     (get_int (Objc.invoke Objc.tag_int repr (Selector.find "dayOfMonth:")[]) : int)
   method dayOfWeek =
     (get_int (Objc.invoke Objc.tag_int repr (Selector.find "dayOfWeek:")[]) : int)
   method dayOfYear =
     (get_int (Objc.invoke Objc.tag_int repr (Selector.find "dayOfYear:")[]) : int)
   method dayOfCommonEra =
     (get_int (Objc.invoke Objc.tag_int repr (Selector.find "dayOfCommonEra:")[]) : int)
   method hourOfDay =
     (get_int (Objc.invoke Objc.tag_int repr (Selector.find "hourOfDay:")[]) : int)
   method minuteOfHour =
     (get_int (Objc.invoke Objc.tag_int repr (Selector.find "minuteOfHour:")[]) : int)
   method secondOfMinute =
     (get_int (Objc.invoke Objc.tag_int repr (Selector.find "secondOfMinute:")[]) : int)
...
(* methods for category NSCalendarDateExtras *)
   method dateWithString (aString : [`NSString] Objc.t) =
     (get_pointer (Objc.invoke Objc.tag_pointer repr (Selector.find "dateWithString:")[make_pointer_from_object aString]) : [`NSDate] Objc.nativeNSObject)
end
...
(* methods for category NSCalendarDateExtras *)
   method initWithString (description : [`NSString] Objc.t) =
     (get_pointer (Objc.invoke Objc.tag_pointer repr (Selector.find "initWithString:")[make_pointer_from_object description]) : [`NSObject] Objc.nativeNSObject)
