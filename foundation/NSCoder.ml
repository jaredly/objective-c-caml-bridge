...
let _ = init()
let make_NSObject_of_NSCoder (o : [`NSCoder] nativeNSObject) = (Obj.magic o : [`NSObject] nativeNSObject)
...
class native_NSCoder = fun (o : [`NSCoder] nativeNSObject) -> object (self)
   inherit native_NSObject (make_NSObject_of_NSCoder o) as super
(* methods for category NSTypedstreamCompatibility *)
   method encodeNXObject (_object : [`NSObject] Objc.t) =
     (get_unit (Objc.invoke Objc.tag_unit repr (Selector.find "encodeNXObject:")[make_pointer_from_object _object]) : unit)
   method decodeNXObject =
     (get_pointer (Objc.invoke Objc.tag_pointer repr (Selector.find "decodeNXObject:")[]) : [`NSObject] Objc.nativeNSObject)
(* methods for category NSExtendedCoder *)
   (* skipping selector encodeObject *)
   method encodePropertyList (aPropertyList : [`NSObject] Objc.t) =
     (get_unit (Objc.invoke Objc.tag_unit repr (Selector.find "encodePropertyList:")[make_pointer_from_object aPropertyList]) : unit)
   ...
   method encodeBycopyObject (anObject : [`NSObject] Objc.t) =
     (get_unit (Objc.invoke Objc.tag_unit repr (Selector.find "encodeBycopyObject:")[make_pointer_from_object anObject]) : unit)
   method encodeByrefObject (anObject : [`NSObject] Objc.t) =
     (get_unit (Objc.invoke Objc.tag_unit repr (Selector.find "encodeByrefObject:")[make_pointer_from_object anObject]) : unit)
...
*)
   ...
   method decodeObject =
     (get_pointer (Objc.invoke Objc.tag_pointer repr (Selector.find "decodeObject:")[]) : [`NSObject] Objc.nativeNSObject)
   method decodePropertyList =
     (get_pointer (Objc.invoke Objc.tag_pointer repr (Selector.find "decodePropertyList:")[]) : [`NSObject] Objc.nativeNSObject)
...
(*  UNSUPPORTED
   method decodeBytesWithReturnedLength (lengthp : (*pointer to unsigned int*) unsupported) =
     (get_pointer (Objc.invoke Objc.tag_pointer repr (Selector.find "decodeBytesWithReturnedLength:")[(*pointer to unsigned int*) unsupported lengthp]) : [`void] Objc.nativeNSObject)
...
*)
   ...
   method allowsKeyedCoding =
     (get_bool (Objc.invoke Objc.tag_bool repr (Selector.find "allowsKeyedCoding:")[]) : bool)
...
*)
   method encodeDataObject (data : [`NSData] Objc.t) =
     (get_unit (Objc.invoke Objc.tag_unit repr (Selector.find "encodeDataObject:")[make_pointer_from_object data]) : unit)
   ...
   method decodeDataObject =
     (get_pointer (Objc.invoke Objc.tag_pointer repr (Selector.find "decodeDataObject:")[]) : [`NSData] Objc.nativeNSObject)
   method versionForClassName (className : [`NSString] Objc.t) =
     (get_int (Objc.invoke Objc.tag_int repr (Selector.find "versionForClassName:")[make_pointer_from_object className]) : int)
end
