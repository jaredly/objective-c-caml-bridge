...
let class_NSMutableString = object
   val o = Classes.find "NSMutableString"
   method _new = (Objc.objcnew o : [`NSMutableString] nativeNSObject)
(* methods for category NSMutableStringExtensionMethods *)
   method stringWithCapacity (capacity : int) =
     (get_pointer (Objc.invoke Objc.tag_pointer o (Selector.find "stringWithCapacity:")[make_int capacity]) : [`NSMutableString] Objc.nativeNSObject)
end
...
(* methods for category NSMutableStringExtensionMethods *)
   ...
   method appendString (aString : [`NSString] Objc.t) =
     (get_unit (Objc.invoke Objc.tag_unit o (Selector.find "appendString:")[make_pointer_from_object aString]) : unit)
   method setString (aString : [`NSString] Objc.t) =
     (get_unit (Objc.invoke Objc.tag_unit o (Selector.find "setString:")[make_pointer_from_object aString]) : unit)
   method initWithCapacity (capacity : int) =
     (get_pointer (Objc.invoke Objc.tag_pointer o (Selector.find "initWithCapacity:")[make_int capacity]) : [`NSObject] Objc.nativeNSObject)
...
(* methods for category NSStringExtensionMethods *)
   method defaultCStringEncoding =
     (get_pointer (Objc.invoke Objc.tag_pointer o (Selector.find "defaultCStringEncoding:")[]) : [`NSString] Objc.nativeNSObject)
(*  UNSUPPORTED
   method availableStringEncodings =
     ((*pointer to const NSStringEncoding*) unsupported (Objc.invoke (*pointer to const NSStringEncoding*) Objc.tag_unsupported o (Selector.find "availableStringEncodings:")[]) : (*pointer to const NSStringEncoding*) unsupported)

*)
   method localizedNameOfStringEncoding (encoding : int64) =
     (get_pointer (Objc.invoke Objc.tag_pointer o (Selector.find "localizedNameOfStringEncoding:")[make_int64 encoding]) : [`NSString] Objc.nativeNSObject)
   method string =
   ...
   method stringWithString (string : [`NSString] Objc.t) =
     (get_pointer (Objc.invoke Objc.tag_pointer o (Selector.find "stringWithString:")[make_pointer_from_object string]) : [`NSString] Objc.nativeNSObject)
(*  UNSUPPORTED
...
*)
   method stringWithUTF8String (nullTerminatedCString : string) =
     (get_pointer (Objc.invoke Objc.tag_pointer o (Selector.find "stringWithUTF8String:")[make_string nullTerminatedCString]) : [`NSString] Objc.nativeNSObject)
...
(* methods for category NSStringDeprecated *)
   method cString =
     (get_string (Objc.invoke Objc.tag_string o (Selector.find "cString:")[]) : string)
   method lossyCString =
     (get_string (Objc.invoke Objc.tag_string o (Selector.find "lossyCString:")[]) : string)
   method cStringLength =
     (get_int (Objc.invoke Objc.tag_int o (Selector.find "cStringLength:")[]) : int)
...
(* methods for category NSExtendedStringPropertyListParsing *)
   method propertyList =
     (get_pointer (Objc.invoke Objc.tag_pointer o (Selector.find "propertyList:")[]) : [`NSObject] Objc.nativeNSObject)
   method propertyListFromStringsFileFormat =
     (get_pointer (Objc.invoke Objc.tag_pointer o (Selector.find "propertyListFromStringsFileFormat:")[]) : [`NSDictionary] Objc.nativeNSObject)
(* methods for category NSStringExtensionMethods *)
   ...
   method substringFromIndex (from : int) =
     (get_pointer (Objc.invoke Objc.tag_pointer o (Selector.find "substringFromIndex:")[make_int from]) : [`NSString] Objc.nativeNSObject)
   method substringToIndex (_to : int) =
     (get_pointer (Objc.invoke Objc.tag_pointer o (Selector.find "substringToIndex:")[make_int _to]) : [`NSString] Objc.nativeNSObject)
   method substringWithRange (range : int * int) =
     (get_pointer (Objc.invoke Objc.tag_pointer o (Selector.find "substringWithRange:")[make_range range]) : [`NSString] Objc.nativeNSObject)
   ...
   method caseInsensitiveCompare (string : [`NSString] Objc.t) =
     (get_int (Objc.invoke Objc.tag_int o (Selector.find "caseInsensitiveCompare:")[make_pointer_from_object string]) : int)
   method localizedCompare (string : [`NSString] Objc.t) =
     (get_int (Objc.invoke Objc.tag_int o (Selector.find "localizedCompare:")[make_pointer_from_object string]) : int)
   method localizedCaseInsensitiveCompare (string : [`NSString] Objc.t) =
     (get_int (Objc.invoke Objc.tag_int o (Selector.find "localizedCaseInsensitiveCompare:")[make_pointer_from_object string]) : int)
   method isEqualToString (aString : [`NSString] Objc.t) =
     (get_bool (Objc.invoke Objc.tag_bool o (Selector.find "isEqualToString:")[make_pointer_from_object aString]) : bool)
   method hasPrefix (aString : [`NSString] Objc.t) =
     (get_bool (Objc.invoke Objc.tag_bool o (Selector.find "hasPrefix:")[make_pointer_from_object aString]) : bool)
   method hasSuffix (aString : [`NSString] Objc.t) =
     (get_bool (Objc.invoke Objc.tag_bool o (Selector.find "hasSuffix:")[make_pointer_from_object aString]) : bool)
   ...
   method rangeOfComposedCharacterSequenceAtIndex (index : int) =
     (get_range (Objc.invoke Objc.tag_nsrange o (Selector.find "rangeOfComposedCharacterSequenceAtIndex:")[make_int index]) : (int * int))
   method stringByAppendingString (aString : [`NSString] Objc.t) =
     (get_pointer (Objc.invoke Objc.tag_pointer o (Selector.find "stringByAppendingString:")[make_pointer_from_object aString]) : [`NSString] Objc.nativeNSObject)
   method doubleValue =
   ...
   method componentsSeparatedByString (separator : [`NSString] Objc.t) =
     (get_pointer (Objc.invoke Objc.tag_pointer o (Selector.find "componentsSeparatedByString:")[make_pointer_from_object separator]) : [`NSArray] Objc.nativeNSObject)
   ...
   method uppercaseString =
     (get_pointer (Objc.invoke Objc.tag_pointer o (Selector.find "uppercaseString:")[]) : [`NSString] Objc.nativeNSObject)
   method lowercaseString =
     (get_pointer (Objc.invoke Objc.tag_pointer o (Selector.find "lowercaseString:")[]) : [`NSString] Objc.nativeNSObject)
   method capitalizedString =
     (get_pointer (Objc.invoke Objc.tag_pointer o (Selector.find "capitalizedString:")[]) : [`NSString] Objc.nativeNSObject)
   method stringByTrimmingCharactersInSet (set : [`NSCharacterSet] Objc.t) =
     (get_pointer (Objc.invoke Objc.tag_pointer o (Selector.find "stringByTrimmingCharactersInSet:")[make_pointer_from_object set]) : [`NSString] Objc.nativeNSObject)
...
*)
   method lineRangeForRange (range : int * int) =
     (get_range (Objc.invoke Objc.tag_nsrange o (Selector.find "lineRangeForRange:")[make_range range]) : (int * int))
(*  UNSUPPORTED
...
*)
   method paragraphRangeForRange (range : int * int) =
     (get_range (Objc.invoke Objc.tag_nsrange o (Selector.find "paragraphRangeForRange:")[make_range range]) : (int * int))
   method description =
     (get_pointer (Objc.invoke Objc.tag_pointer o (Selector.find "description:")[]) : [`NSString] Objc.nativeNSObject)
   method hash =
     (get_int (Objc.invoke Objc.tag_int o (Selector.find "hash:")[]) : int)
   method fastestEncoding =
     (get_int64 (Objc.invoke Objc.tag_int64 o (Selector.find "fastestEncoding:")[]) : int64)
   method smallestEncoding =
     (get_int64 (Objc.invoke Objc.tag_int64 o (Selector.find "smallestEncoding:")[]) : int64)
   ...
   method canBeConvertedToEncoding (encoding : int64) =
     (get_bool (Objc.invoke Objc.tag_bool o (Selector.find "canBeConvertedToEncoding:")[make_int64 encoding]) : bool)
   method cStringUsingEncoding (encoding : int64) =
     (get_string (Objc.invoke Objc.tag_string o (Selector.find "cStringUsingEncoding:")[make_int64 encoding]) : string)
   (* skipping selector getCString:maxLength:encoding *)
   method maximumLengthOfBytesUsingEncoding (enc : int64) =
     (get_int (Objc.invoke Objc.tag_int o (Selector.find "maximumLengthOfBytesUsingEncoding:")[make_int64 enc]) : int)
   method lengthOfBytesUsingEncoding (enc : int64) =
     (get_int (Objc.invoke Objc.tag_int o (Selector.find "lengthOfBytesUsingEncoding:")[make_int64 enc]) : int)
   method decomposedStringWithCanonicalMapping =
     (get_pointer (Objc.invoke Objc.tag_pointer o (Selector.find "decomposedStringWithCanonicalMapping:")[]) : [`NSString] Objc.nativeNSObject)
   method precomposedStringWithCanonicalMapping =
     (get_pointer (Objc.invoke Objc.tag_pointer o (Selector.find "precomposedStringWithCanonicalMapping:")[]) : [`NSString] Objc.nativeNSObject)
   method decomposedStringWithCompatibilityMapping =
     (get_pointer (Objc.invoke Objc.tag_pointer o (Selector.find "decomposedStringWithCompatibilityMapping:")[]) : [`NSString] Objc.nativeNSObject)
   method precomposedStringWithCompatibilityMapping =
     (get_pointer (Objc.invoke Objc.tag_pointer o (Selector.find "precomposedStringWithCompatibilityMapping:")[]) : [`NSString] Objc.nativeNSObject)
   method l_UTF8String =
     (get_string (Objc.invoke Objc.tag_string o (Selector.find "l_UTF8String:")[]) : string)
   method init =
...
*)
   method initWithUTF8String (nullTerminatedCString : string) =
     (get_pointer (Objc.invoke Objc.tag_pointer o (Selector.find "initWithUTF8String:")[make_string nullTerminatedCString]) : [`NSObject] Objc.nativeNSObject)
   method initWithString (aString : [`NSString] Objc.t) =
     (get_pointer (Objc.invoke Objc.tag_pointer o (Selector.find "initWithString:")[make_pointer_from_object aString]) : [`NSObject] Objc.nativeNSObject)
...
(*  UNSUPPORTED
   method characterAtIndex (index : int) =
     ((*unichar*) unsupported (Objc.invoke (*unichar*) Objc.tag_unsupported o (Selector.find "characterAtIndex:")[make_int index]) : (*unichar*) unsupported)

*)
end
(* Class object for NSSimpleCString *)
let class_NSSimpleCString = object
   val o = Classes.find "NSSimpleCString"
   method _new = (Objc.objcnew o : [`NSSimpleCString] nativeNSObject)
end
...
let class_NSConstantString = object
   val o = Classes.find "NSConstantString"
   method _new = (Objc.objcnew o : [`NSConstantString] nativeNSObject)
end
