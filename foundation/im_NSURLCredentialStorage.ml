...
class virtual methods = object (self)
  ...
  method setCredential_forProtectionSpace  (credential : [`NSURLCredential] Objc.t) (space : [`NSURLProtectionSpace] Objc.t) =
    let sel, args = (
      ...
      (get_unit (Objc.invoke Objc.tag_unit self#repr (Selector.find_list sel) args)
       : unit)
  method removeCredential_forProtectionSpace  (credential : [`NSURLCredential] Objc.t) (space : [`NSURLProtectionSpace] Objc.t) =
    let sel, args = (
  ...
  method setDefaultCredential_forProtectionSpace  (credential : [`NSURLCredential] Objc.t) (space : [`NSURLProtectionSpace] Objc.t) =
    let sel, args = (
