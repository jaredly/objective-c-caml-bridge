...
let class_NSMutableData = object
   val o = Classes.find "NSMutableData"
   method _new = (Objc.objcnew o : [`NSMutableData] nativeNSObject)
(* methods for category NSMutableDataCreation *)
   method dataWithCapacity (aNumItems : int) =
     (get_pointer (Objc.invoke Objc.tag_pointer o (Selector.find "dataWithCapacity:")[make_int aNumItems]) : [`NSMutableData] Objc.nativeNSObject)
   method dataWithLength (length : int) =
     (get_pointer (Objc.invoke Objc.tag_pointer o (Selector.find "dataWithLength:")[make_int length]) : [`NSMutableData] Objc.nativeNSObject)
...
(* methods for category NSMutableDataCreation *)
   ...
   method initWithLength (length : int) =
     (get_pointer (Objc.invoke Objc.tag_pointer o (Selector.find "initWithLength:")[make_int length]) : [`NSObject] Objc.nativeNSObject)
(* methods for category NSExtendedMutableData *)
(*  UNSUPPORTED
...
*)
   method appendData (other : [`NSData] Objc.t) =
     (get_unit (Objc.invoke Objc.tag_unit o (Selector.find "appendData:")[make_pointer_from_object other]) : unit)
   method increaseLengthBy (extraLength : int) =
     (get_unit (Objc.invoke Objc.tag_unit o (Selector.find "increaseLengthBy:")[make_int extraLength]) : unit)
   (* skipping selector replaceBytesInRange:withBytes *)
   method resetBytesInRange (range : int * int) =
     (get_unit (Objc.invoke Objc.tag_unit o (Selector.find "resetBytesInRange:")[make_range range]) : unit)
   method setData (data : [`NSData] Objc.t) =
     (get_unit (Objc.invoke Objc.tag_unit o (Selector.find "setData:")[make_pointer_from_object data]) : unit)
(*  UNSUPPORTED
...
*)
   method mutableBytes =
     (get_pointer (Objc.invoke Objc.tag_pointer o (Selector.find "mutableBytes:")[]) : [`void] Objc.nativeNSObject)
   method setLength (length : int) =
     (get_unit (Objc.invoke Objc.tag_unit o (Selector.find "setLength:")[make_int length]) : unit)
end
(* Class object for NSData *)
let class_NSData = object
   val o = Classes.find "NSData"
   method _new = (Objc.objcnew o : [`NSData] nativeNSObject)
...
*)
   ...
   method dataWithContentsOfMappedFile (path : [`NSString] Objc.t) =
     (get_pointer (Objc.invoke Objc.tag_pointer o (Selector.find "dataWithContentsOfMappedFile:")[make_pointer_from_object path]) : [`NSData] Objc.nativeNSObject)
   method dataWithData (data : [`NSData] Objc.t) =
     (get_pointer (Objc.invoke Objc.tag_pointer o (Selector.find "dataWithData:")[make_pointer_from_object data]) : [`NSData] Objc.nativeNSObject)
...
*)
   ...
   method initWithContentsOfMappedFile (path : [`NSString] Objc.t) =
     (get_pointer (Objc.invoke Objc.tag_pointer o (Selector.find "initWithContentsOfMappedFile:")[make_pointer_from_object path]) : [`NSObject] Objc.nativeNSObject)
...
(* methods for category NSExtendedData *)
   ...
   method isEqualToData (other : [`NSData] Objc.t) =
     (get_bool (Objc.invoke Objc.tag_bool o (Selector.find "isEqualToData:")[make_pointer_from_object other]) : bool)
   method subdataWithRange (range : int * int) =
     (get_pointer (Objc.invoke Objc.tag_pointer o (Selector.find "subdataWithRange:")[make_range range]) : [`NSData] Objc.nativeNSObject)
...
(*  UNSUPPORTED
   method bytes =
     ((*pointer to const void*) unsupported (Objc.invoke (*pointer to const void*) Objc.tag_unsupported o (Selector.find "bytes:")[]) : (*pointer to const void*) unsupported)
