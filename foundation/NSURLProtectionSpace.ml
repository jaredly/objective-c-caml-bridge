...
let class_NSURLProtectionSpace = object
   val o = Classes.find "NSURLProtectionSpace"
   method _new = (Objc.objcnew o : [`NSURLProtectionSpace] nativeNSObject)
end
...
class native_NSURLProtectionSpace = fun (o : [`NSURLProtectionSpace] nativeNSObject) -> object (self)
   ...
   method initWithProxyHost  ~port:(port : int ) ~l_type:(_type : [`NSString] Objc.t ) ~realm:(realm : [`NSString] Objc.t ) ~authenticationMethod:(authenticationMethod : [`NSString] Objc.t ) (host : [`NSString] Objc.t) =
     let sel, args = (
       ...
       (get_pointer (Objc.invoke Objc.tag_pointer o (Selector.find_list sel) args) : [`NSObject] Objc.nativeNSObject)
   method realm =
     (get_pointer (Objc.invoke Objc.tag_pointer o (Selector.find "realm:")[]) : [`NSString] Objc.nativeNSObject)
   method receivesCredentialSecurely =
     (get_bool (Objc.invoke Objc.tag_bool o (Selector.find "receivesCredentialSecurely:")[]) : bool)
   method isProxy =
     (get_bool (Objc.invoke Objc.tag_bool o (Selector.find "isProxy:")[]) : bool)
   method host =
     (get_pointer (Objc.invoke Objc.tag_pointer o (Selector.find "host:")[]) : [`NSString] Objc.nativeNSObject)
   method port =
     (get_int (Objc.invoke Objc.tag_int o (Selector.find "port:")[]) : int)
   method proxyType =
     (get_pointer (Objc.invoke Objc.tag_pointer o (Selector.find "proxyType:")[]) : [`NSString] Objc.nativeNSObject)
   method protocol =
     (get_pointer (Objc.invoke Objc.tag_pointer o (Selector.find "protocol:")[]) : [`NSString] Objc.nativeNSObject)
   method authenticationMethod =
     (get_pointer (Objc.invoke Objc.tag_pointer o (Selector.find "authenticationMethod:")[]) : [`NSString] Objc.nativeNSObject)
end
