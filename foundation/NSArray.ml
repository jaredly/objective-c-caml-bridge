...
(* methods for category NSMutableArrayCreation *)
   method arrayWithCapacity (numItems : int) =
     (get_pointer (Objc.invoke Objc.tag_pointer o (Selector.find "arrayWithCapacity:")[make_int numItems]) : [`NSMutableArray] Objc.nativeNSObject)
...
(* methods for category NSExtendedMutableArray *)
   method addObjectsFromArray (otherArray : [`NSArray] Objc.t) =
     (get_unit (Objc.invoke Objc.tag_unit o (Selector.find "addObjectsFromArray:")[make_pointer_from_object otherArray]) : unit)
...
*)
   method removeObjectsInArray (otherArray : [`NSArray] Objc.t) =
     (get_unit (Objc.invoke Objc.tag_unit o (Selector.find "removeObjectsInArray:")[make_pointer_from_object otherArray]) : unit)
   method removeObjectsInRange (range : int * int) =
     (get_unit (Objc.invoke Objc.tag_unit o (Selector.find "removeObjectsInRange:")[make_range range]) : unit)
   ...
   method setArray (otherArray : [`NSArray] Objc.t) =
     (get_unit (Objc.invoke Objc.tag_unit o (Selector.find "setArray:")[make_pointer_from_object otherArray]) : unit)
(*  UNSUPPORTED
...
*)
   ...
   method removeObjectsAtIndexes (indexes : [`NSIndexSet] Objc.t) =
     (get_unit (Objc.invoke Objc.tag_unit o (Selector.find "removeObjectsAtIndexes:")[make_pointer_from_object indexes]) : unit)
   ...
   method removeLastObject =
     (get_unit (Objc.invoke Objc.tag_unit o (Selector.find "removeLastObject:")[]) : unit)
   method removeObjectAtIndex (index : int) =
     (get_unit (Objc.invoke Objc.tag_unit o (Selector.find "removeObjectAtIndex:")[make_int index]) : unit)
...
(* methods for category NSArrayCreation *)
   method array =
     (get_pointer (Objc.invoke Objc.tag_pointer o (Selector.find "array:")[]) : [`NSArray] Objc.nativeNSObject)
   method arrayWithContentsOfFile (path : [`NSString] Objc.t) =
     (get_pointer (Objc.invoke Objc.tag_pointer o (Selector.find "arrayWithContentsOfFile:")[make_pointer_from_object path]) : [`NSArray] Objc.nativeNSObject)
   method arrayWithContentsOfURL (url : [`NSURL] Objc.t) =
     (get_pointer (Objc.invoke Objc.tag_pointer o (Selector.find "arrayWithContentsOfURL:")[make_pointer_from_object url]) : [`NSArray] Objc.nativeNSObject)
   method arrayWithObject (anObject : [`NSObject] Objc.t) =
     (get_pointer (Objc.invoke Objc.tag_pointer o (Selector.find "arrayWithObject:")[make_pointer_from_object anObject]) : [`NSArray] Objc.nativeNSObject)
   method arrayWithArray (array : [`NSArray] Objc.t) =
     (get_pointer (Objc.invoke Objc.tag_pointer o (Selector.find "arrayWithArray:")[make_pointer_from_object array]) : [`NSArray] Objc.nativeNSObject)
...
(* methods for category NSExtendedArray *)
   method arrayByAddingObject (anObject : [`NSObject] Objc.t) =
     (get_pointer (Objc.invoke Objc.tag_pointer o (Selector.find "arrayByAddingObject:")[make_pointer_from_object anObject]) : [`NSArray] Objc.nativeNSObject)
   method arrayByAddingObjectsFromArray (otherArray : [`NSArray] Objc.t) =
     (get_pointer (Objc.invoke Objc.tag_pointer o (Selector.find "arrayByAddingObjectsFromArray:")[make_pointer_from_object otherArray]) : [`NSArray] Objc.nativeNSObject)
   method componentsJoinedByString (separator : [`NSString] Objc.t) =
     (get_pointer (Objc.invoke Objc.tag_pointer o (Selector.find "componentsJoinedByString:")[make_pointer_from_object separator]) : [`NSString] Objc.nativeNSObject)
   ...
   method firstObjectCommonWithArray (otherArray : [`NSArray] Objc.t) =
     (get_pointer (Objc.invoke Objc.tag_pointer o (Selector.find "firstObjectCommonWithArray:")[make_pointer_from_object otherArray]) : [`NSObject] Objc.nativeNSObject)
   ...
   method isEqualToArray (otherArray : [`NSArray] Objc.t) =
     (get_bool (Objc.invoke Objc.tag_bool o (Selector.find "isEqualToArray:")[make_pointer_from_object otherArray]) : bool)
   method lastObject =
     (get_pointer (Objc.invoke Objc.tag_pointer o (Selector.find "lastObject:")[]) : [`NSObject] Objc.nativeNSObject)
   ...
   method reverseObjectEnumerator =
     (get_pointer (Objc.invoke Objc.tag_pointer o (Selector.find "reverseObjectEnumerator:")[]) : [`NSEnumerator] Objc.nativeNSObject)
   method sortedArrayHint =
     (get_pointer (Objc.invoke Objc.tag_pointer o (Selector.find "sortedArrayHint:")[]) : [`NSData] Objc.nativeNSObject)
...
*)
   method sortedArrayUsingSelector (comparator : selector) =
     (get_pointer (Objc.invoke Objc.tag_pointer o (Selector.find "sortedArrayUsingSelector:")[make_selector comparator]) : [`NSArray] Objc.nativeNSObject)
   method subarrayWithRange (range : int * int) =
     (get_pointer (Objc.invoke Objc.tag_pointer o (Selector.find "subarrayWithRange:")[make_range range]) : [`NSArray] Objc.nativeNSObject)
   ...
   method objectsAtIndexes (indexes : [`NSIndexSet] Objc.t) =
     (get_pointer (Objc.invoke Objc.tag_pointer o (Selector.find "objectsAtIndexes:")[make_pointer_from_object indexes]) : [`NSArray] Objc.nativeNSObject)
   method count =
     (get_int (Objc.invoke Objc.tag_int o (Selector.find "count:")[]) : int)
   method objectAtIndex (index : int) =
     (get_pointer (Objc.invoke Objc.tag_pointer o (Selector.find "objectAtIndex:")[make_int index]) : [`NSObject] Objc.nativeNSObject)
end
