...
let class_NSWorkspace = object
   val o = Classes.find "NSWorkspace"
   method _new = (Objc.objcnew o : [`NSWorkspace] nativeNSObject)
   method sharedWorkspace =
     (get_pointer (Objc.invoke Objc.tag_pointer o (Selector.find "sharedWorkspace:")[]) : [`NSWorkspace] Objc.nativeNSObject)
end
...
class native_NSWorkspace = fun (o : [`NSWorkspace] nativeNSObject) -> object (self)
   ...
   method notificationCenter =
     (get_pointer (Objc.invoke Objc.tag_pointer o (Selector.find "notificationCenter:")[]) : [`NSNotificationCenter] Objc.nativeNSObject)
   ...
   method openTempFile (fullPath : [`NSString] Objc.t) =
     (get_bool (Objc.invoke Objc.tag_bool o (Selector.find "openTempFile:")[make_pointer_from_object fullPath]) : bool)
(*  UNSUPPORTED
...
*)
   method openURL (url : [`NSURL] Objc.t) =
     (get_bool (Objc.invoke Objc.tag_bool o (Selector.find "openURL:")[make_pointer_from_object url]) : bool)
   ...
   method fullPathForApplication (appName : [`NSString] Objc.t) =
     (get_pointer (Objc.invoke Objc.tag_pointer o (Selector.find "fullPathForApplication:")[make_pointer_from_object appName]) : [`NSString] Objc.nativeNSObject)
   ...
   method findApplications =
     (get_unit (Objc.invoke Objc.tag_unit o (Selector.find "findApplications:")[]) : unit)
   (* skipping selector noteFileSystemChanged *)
   method noteFileSystemChanged (path : [`NSString] Objc.t) =
     (get_unit (Objc.invoke Objc.tag_unit o (Selector.find "noteFileSystemChanged:")[make_pointer_from_object path]) : unit)
   method fileSystemChanged =
     (get_bool (Objc.invoke Objc.tag_bool o (Selector.find "fileSystemChanged:")[]) : bool)
   method noteUserDefaultsChanged =
     (get_unit (Objc.invoke Objc.tag_unit o (Selector.find "noteUserDefaultsChanged:")[]) : unit)
   method userDefaultsChanged =
     (get_bool (Objc.invoke Objc.tag_bool o (Selector.find "userDefaultsChanged:")[]) : bool)
(*  UNSUPPORTED
...
*)
   method isFilePackageAtPath (fullPath : [`NSString] Objc.t) =
     (get_bool (Objc.invoke Objc.tag_bool o (Selector.find "isFilePackageAtPath:")[make_pointer_from_object fullPath]) : bool)
   method iconForFile (fullPath : [`NSString] Objc.t) =
     (get_pointer (Objc.invoke Objc.tag_pointer o (Selector.find "iconForFile:")[make_pointer_from_object fullPath]) : [`NSImage] Objc.nativeNSObject)
   method iconForFiles (fullPaths : [`NSArray] Objc.t) =
     (get_pointer (Objc.invoke Objc.tag_pointer o (Selector.find "iconForFiles:")[make_pointer_from_object fullPaths]) : [`NSImage] Objc.nativeNSObject)
   method iconForFileType (fileType : [`NSString] Objc.t) =
     (get_pointer (Objc.invoke Objc.tag_pointer o (Selector.find "iconForFileType:")[make_pointer_from_object fileType]) : [`NSImage] Objc.nativeNSObject)
...
*)
   ...
   method unmountAndEjectDeviceAtPath (path : [`NSString] Objc.t) =
     (get_bool (Objc.invoke Objc.tag_bool o (Selector.find "unmountAndEjectDeviceAtPath:")[make_pointer_from_object path]) : bool)
   method extendPowerOffBy (requested : int) =
     (get_int (Objc.invoke Objc.tag_int o (Selector.find "extendPowerOffBy:")[make_int requested]) : int)
(*  UNSUPPORTED
...
*)
   method hideOtherApplications =
     (get_unit (Objc.invoke Objc.tag_unit o (Selector.find "hideOtherApplications:")[]) : unit)
   method mountedLocalVolumePaths =
     (get_pointer (Objc.invoke Objc.tag_pointer o (Selector.find "mountedLocalVolumePaths:")[]) : [`NSArray] Objc.nativeNSObject)
   method mountedRemovableMedia =
     (get_pointer (Objc.invoke Objc.tag_pointer o (Selector.find "mountedRemovableMedia:")[]) : [`NSArray] Objc.nativeNSObject)
   method mountNewRemovableMedia =
     (get_pointer (Objc.invoke Objc.tag_pointer o (Selector.find "mountNewRemovableMedia:")[]) : [`NSArray] Objc.nativeNSObject)
   method checkForRemovableMedia =
     (get_unit (Objc.invoke Objc.tag_unit o (Selector.find "checkForRemovableMedia:")[]) : unit)
   method absolutePathForAppBundleWithIdentifier (bundleIdentifier : [`NSString] Objc.t) =
     (get_pointer (Objc.invoke Objc.tag_pointer o (Selector.find "absolutePathForAppBundleWithIdentifier:")[make_pointer_from_object bundleIdentifier]) : [`NSString] Objc.nativeNSObject)
(*  UNSUPPORTED
...
*)
   method launchedApplications =
     (get_pointer (Objc.invoke Objc.tag_pointer o (Selector.find "launchedApplications:")[]) : [`NSArray] Objc.nativeNSObject)
   method activeApplication =
     (get_pointer (Objc.invoke Objc.tag_pointer o (Selector.find "activeApplication:")[]) : [`NSDictionary] Objc.nativeNSObject)
end
