...
(* methods for category NSKeyboardUI *)
   method defaultFocusRingType =
     (get_pointer (Objc.invoke Objc.tag_pointer o (Selector.find "defaultFocusRingType:")[]) : [`NSView] Objc.nativeNSObject)
   method focusView =
     (get_pointer (Objc.invoke Objc.tag_pointer o (Selector.find "focusView:")[]) : [`NSView] Objc.nativeNSObject)
   method defaultMenu =
...
*)
   method registeredDraggedTypes =
     (get_pointer (Objc.invoke Objc.tag_pointer o (Selector.find "registeredDraggedTypes:")[]) : [`NSArray] Objc.nativeNSObject)
...
(*  UNSUPPORTED
   method knowsPageRange (range : (*NSRangePointer*) unsupported) =
     (get_bool (Objc.invoke Objc.tag_bool o (Selector.find "knowsPageRange:")[(*NSRangePointer*) unsupported range]) : bool)

*)
   method heightAdjustLimit =
     (get_float (Objc.invoke Objc.tag_float o (Selector.find "heightAdjustLimit:")[]) : float)
   method widthAdjustLimit =
     (get_float (Objc.invoke Objc.tag_float o (Selector.find "widthAdjustLimit:")[]) : float)
...
(*  UNSUPPORTED
   method rectForPage (page : int) =
     ((*NSRect*) unsupported (Objc.invoke (*NSRect*) Objc.tag_unsupported o (Selector.find "rectForPage:")[make_int page]) : (*NSRect*) unsupported)

*)
(*  UNSUPPORTED
   method locationOfPrintRect (aRect : (*NSRect*) unsupported) =
     ((*NSPoint*) unsupported (Objc.invoke (*NSPoint*) Objc.tag_unsupported o (Selector.find "locationOfPrintRect:")[(*NSRect*) unsupported aRect]) : (*NSPoint*) unsupported)

*)
(*  UNSUPPORTED
   method drawPageBorderWithSize (borderSize : (*NSSize*) unsupported) =
     (get_unit (Objc.invoke Objc.tag_unit o (Selector.find "drawPageBorderWithSize:")[(*NSSize*) unsupported borderSize]) : unit)

*)
   method pageHeader =
     (get_pointer (Objc.invoke Objc.tag_pointer o (Selector.find "pageHeader:")[]) : [`NSAttributedString] Objc.nativeNSObject)
   method pageFooter =
     (get_pointer (Objc.invoke Objc.tag_pointer o (Selector.find "pageFooter:")[]) : [`NSAttributedString] Objc.nativeNSObject)
(*  UNSUPPORTED
   method drawSheetBorderWithSize (borderSize : (*NSSize*) unsupported) =
     (get_unit (Objc.invoke Objc.tag_unit o (Selector.find "drawSheetBorderWithSize:")[(*NSSize*) unsupported borderSize]) : unit)

*)
   method printJobTitle =
     (get_pointer (Objc.invoke Objc.tag_pointer o (Selector.find "printJobTitle:")[]) : [`NSString] Objc.nativeNSObject)
   method beginDocument =
     (get_unit (Objc.invoke Objc.tag_unit o (Selector.find "beginDocument:")[]) : unit)
   method endDocument =
     (get_unit (Objc.invoke Objc.tag_unit o (Selector.find "endDocument:")[]) : unit)
(*  UNSUPPORTED
...
*)
   method endPage =
     (get_unit (Objc.invoke Objc.tag_unit o (Selector.find "endPage:")[]) : unit)
(* methods for category NSKeyboardUI *)
   ...
   method setNextKeyView (next : [`NSView] Objc.t) =
     (get_unit (Objc.invoke Objc.tag_unit o (Selector.find "setNextKeyView:")[make_pointer_from_object next]) : unit)
   method nextKeyView =
     (get_pointer (Objc.invoke Objc.tag_pointer o (Selector.find "nextKeyView:")[]) : [`NSView] Objc.nativeNSObject)
   method previousKeyView =
     (get_pointer (Objc.invoke Objc.tag_pointer o (Selector.find "previousKeyView:")[]) : [`NSView] Objc.nativeNSObject)
   method nextValidKeyView =
     (get_pointer (Objc.invoke Objc.tag_pointer o (Selector.find "nextValidKeyView:")[]) : [`NSView] Objc.nativeNSObject)
   method previousValidKeyView =
     (get_pointer (Objc.invoke Objc.tag_pointer o (Selector.find "previousValidKeyView:")[]) : [`NSView] Objc.nativeNSObject)
   method canBecomeKeyView =
     (get_bool (Objc.invoke Objc.tag_bool o (Selector.find "canBecomeKeyView:")[]) : bool)
(*  UNSUPPORTED
   method setKeyboardFocusRingNeedsDisplayInRect (rect : (*NSRect*) unsupported) =
     (get_unit (Objc.invoke Objc.tag_unit o (Selector.find "setKeyboardFocusRingNeedsDisplayInRect:")[(*NSRect*) unsupported rect]) : unit)

*)
   method setFocusRingType (focusRingType : int) =
     (get_unit (Objc.invoke Objc.tag_unit o (Selector.find "setFocusRingType:")[make_int focusRingType]) : unit)
   method focusRingType =
     (get_int (Objc.invoke Objc.tag_int o (Selector.find "focusRingType:")[]) : int)
(*  UNSUPPORTED
...
*)
   ...
   method superview =
     (get_pointer (Objc.invoke Objc.tag_pointer o (Selector.find "superview:")[]) : [`NSView] Objc.nativeNSObject)
   method subviews =
     (get_pointer (Objc.invoke Objc.tag_pointer o (Selector.find "subviews:")[]) : [`NSArray] Objc.nativeNSObject)
   method isDescendantOf (aView : [`NSView] Objc.t) =
     (get_bool (Objc.invoke Objc.tag_bool o (Selector.find "isDescendantOf:")[make_pointer_from_object aView]) : bool)
   method ancestorSharedWithView (aView : [`NSView] Objc.t) =
     (get_pointer (Objc.invoke Objc.tag_pointer o (Selector.find "ancestorSharedWithView:")[make_pointer_from_object aView]) : [`NSView] Objc.nativeNSObject)
   method opaqueAncestor =
     (get_pointer (Objc.invoke Objc.tag_pointer o (Selector.find "opaqueAncestor:")[]) : [`NSView] Objc.nativeNSObject)
   method setHidden (flag : bool) =
     (get_unit (Objc.invoke Objc.tag_unit o (Selector.find "setHidden:")[make_bool flag]) : unit)
   method isHidden =
     (get_bool (Objc.invoke Objc.tag_bool o (Selector.find "isHidden:")[]) : bool)
   method isHiddenOrHasHiddenAncestor =
     (get_bool (Objc.invoke Objc.tag_bool o (Selector.find "isHiddenOrHasHiddenAncestor:")[]) : bool)
(*  UNSUPPORTED
...
(*  UNSUPPORTED
   method needsToDrawRect (aRect : (*NSRect*) unsupported) =
     (get_bool (Objc.invoke Objc.tag_bool o (Selector.find "needsToDrawRect:")[(*NSRect*) unsupported aRect]) : bool)

*)
   method wantsDefaultClipping =
     (get_bool (Objc.invoke Objc.tag_bool o (Selector.find "wantsDefaultClipping:")[]) : bool)
...
*)
   method viewWillMoveToWindow (newWindow : [`NSWindow] Objc.t) =
     (get_unit (Objc.invoke Objc.tag_unit o (Selector.find "viewWillMoveToWindow:")[make_pointer_from_object newWindow]) : unit)
   method viewDidMoveToWindow =
     (get_unit (Objc.invoke Objc.tag_unit o (Selector.find "viewDidMoveToWindow:")[]) : unit)
   method viewWillMoveToSuperview (newSuperview : [`NSView] Objc.t) =
     (get_unit (Objc.invoke Objc.tag_unit o (Selector.find "viewWillMoveToSuperview:")[make_pointer_from_object newSuperview]) : unit)
   method viewDidMoveToSuperview =
     (get_unit (Objc.invoke Objc.tag_unit o (Selector.find "viewDidMoveToSuperview:")[]) : unit)
   method didAddSubview (subview : [`NSView] Objc.t) =
     (get_unit (Objc.invoke Objc.tag_unit o (Selector.find "didAddSubview:")[make_pointer_from_object subview]) : unit)
   method willRemoveSubview (subview : [`NSView] Objc.t) =
     (get_unit (Objc.invoke Objc.tag_unit o (Selector.find "willRemoveSubview:")[make_pointer_from_object subview]) : unit)
   method removeFromSuperview =
     (get_unit (Objc.invoke Objc.tag_unit o (Selector.find "removeFromSuperview:")[]) : unit)
   ...
   method removeFromSuperviewWithoutNeedingDisplay =
     (get_unit (Objc.invoke Objc.tag_unit o (Selector.find "removeFromSuperviewWithoutNeedingDisplay:")[]) : unit)
   method setPostsFrameChangedNotifications (flag : bool) =
     (get_unit (Objc.invoke Objc.tag_unit o (Selector.find "setPostsFrameChangedNotifications:")[make_bool flag]) : unit)
   method postsFrameChangedNotifications =
     (get_bool (Objc.invoke Objc.tag_bool o (Selector.find "postsFrameChangedNotifications:")[]) : bool)
(*  UNSUPPORTED
   method resizeSubviewsWithOldSize (oldSize : (*NSSize*) unsupported) =
     (get_unit (Objc.invoke Objc.tag_unit o (Selector.find "resizeSubviewsWithOldSize:")[(*NSSize*) unsupported oldSize]) : unit)

*)
(*  UNSUPPORTED
   method resizeWithOldSuperviewSize (oldSize : (*NSSize*) unsupported) =
     (get_unit (Objc.invoke Objc.tag_unit o (Selector.find "resizeWithOldSuperviewSize:")[(*NSSize*) unsupported oldSize]) : unit)

*)
   method setAutoresizesSubviews (flag : bool) =
     (get_unit (Objc.invoke Objc.tag_unit o (Selector.find "setAutoresizesSubviews:")[make_bool flag]) : unit)
   method autoresizesSubviews =
     (get_bool (Objc.invoke Objc.tag_bool o (Selector.find "autoresizesSubviews:")[]) : bool)
   method setAutoresizingMask (mask : int) =
     (get_unit (Objc.invoke Objc.tag_unit o (Selector.find "setAutoresizingMask:")[make_int mask]) : unit)
   method autoresizingMask =
     (get_int (Objc.invoke Objc.tag_int o (Selector.find "autoresizingMask:")[]) : int)
(*  UNSUPPORTED
   method setFrameOrigin (newOrigin : (*NSPoint*) unsupported) =
     (get_unit (Objc.invoke Objc.tag_unit o (Selector.find "setFrameOrigin:")[(*NSPoint*) unsupported newOrigin]) : unit)
...
(*  UNSUPPORTED
   method setFrame (frameRect : (*NSRect*) unsupported) =
     (get_unit (Objc.invoke Objc.tag_unit o (Selector.find "setFrame:")[(*NSRect*) unsupported frameRect]) : unit)
...
*)
   method setFrameRotation (angle : float) =
     (get_unit (Objc.invoke Objc.tag_unit o (Selector.find "setFrameRotation:")[make_float angle]) : unit)
   method frameRotation =
     (get_float (Objc.invoke Objc.tag_float o (Selector.find "frameRotation:")[]) : float)
(*  UNSUPPORTED
   method setBoundsOrigin (newOrigin : (*NSPoint*) unsupported) =
     (get_unit (Objc.invoke Objc.tag_unit o (Selector.find "setBoundsOrigin:")[(*NSPoint*) unsupported newOrigin]) : unit)

*)
(*  UNSUPPORTED
   method setBoundsSize (newSize : (*NSSize*) unsupported) =
     (get_unit (Objc.invoke Objc.tag_unit o (Selector.find "setBoundsSize:")[(*NSSize*) unsupported newSize]) : unit)

*)
   method setBoundsRotation (angle : float) =
     (get_unit (Objc.invoke Objc.tag_unit o (Selector.find "setBoundsRotation:")[make_float angle]) : unit)
   method boundsRotation =
     (get_float (Objc.invoke Objc.tag_float o (Selector.find "boundsRotation:")[]) : float)
(*  UNSUPPORTED
   method translateOriginToPoint (translation : (*NSPoint*) unsupported) =
     (get_unit (Objc.invoke Objc.tag_unit o (Selector.find "translateOriginToPoint:")[(*NSPoint*) unsupported translation]) : unit)

*)
(*  UNSUPPORTED
   method scaleUnitSquareToSize (newUnitSize : (*NSSize*) unsupported) =
     (get_unit (Objc.invoke Objc.tag_unit o (Selector.find "scaleUnitSquareToSize:")[(*NSSize*) unsupported newUnitSize]) : unit)

*)
   method rotateByAngle (angle : float) =
     (get_unit (Objc.invoke Objc.tag_unit o (Selector.find "rotateByAngle:")[make_float angle]) : unit)
(*  UNSUPPORTED
   method setBounds (aRect : (*NSRect*) unsupported) =
     (get_unit (Objc.invoke Objc.tag_unit o (Selector.find "setBounds:")[(*NSRect*) unsupported aRect]) : unit)
...
*)
   ...
   method isRotatedFromBase =
     (get_bool (Objc.invoke Objc.tag_bool o (Selector.find "isRotatedFromBase:")[]) : bool)
   method isRotatedOrScaledFromBase =
     (get_bool (Objc.invoke Objc.tag_bool o (Selector.find "isRotatedOrScaledFromBase:")[]) : bool)
   method isOpaque =
...
(*  UNSUPPORTED
   method convertPoint  ~fromView:(aView : [`NSView] Objc.t ) (aPoint : (*NSPoint*) unsupported) =
     let sel, args = (
       ...
       ((*NSPoint*) unsupported (Objc.invoke (*NSPoint*) Objc.tag_unsupported o (Selector.find_list sel) args) : (*NSPoint*) unsupported)
...
(*  UNSUPPORTED
   method centerScanRect (aRect : (*NSRect*) unsupported) =
     ((*NSRect*) unsupported (Objc.invoke (*NSRect*) Objc.tag_unsupported o (Selector.find "centerScanRect:")[(*NSRect*) unsupported aRect]) : (*NSRect*) unsupported)

*)
   method canDraw =
     (get_bool (Objc.invoke Objc.tag_bool o (Selector.find "canDraw:")[]) : bool)
...
(*  UNSUPPORTED
   method setNeedsDisplayInRect (invalidRect : (*NSRect*) unsupported) =
     (get_unit (Objc.invoke Objc.tag_unit o (Selector.find "setNeedsDisplayInRect:")[(*NSRect*) unsupported invalidRect]) : unit)
...
*)
   ...
   method lockFocusIfCanDraw =
     (get_bool (Objc.invoke Objc.tag_bool o (Selector.find "lockFocusIfCanDraw:")[]) : bool)
   method lockFocusIfCanDrawInContext (context : [`NSGraphicsContext] Objc.t) =
     (get_bool (Objc.invoke Objc.tag_bool o (Selector.find "lockFocusIfCanDrawInContext:")[make_pointer_from_object context]) : bool)
(*  UNSUPPORTED
   method visibleRect =
     ((*NSRect*) unsupported (Objc.invoke (*NSRect*) Objc.tag_unsupported o (Selector.find "visibleRect:")[]) : (*NSRect*) unsupported)
...
*)
   ...
   method displayIfNeededIgnoringOpacity =
     (get_unit (Objc.invoke Objc.tag_unit o (Selector.find "displayIfNeededIgnoringOpacity:")[]) : unit)
(*  UNSUPPORTED
   method displayRect (rect : (*NSRect*) unsupported) =
     (get_unit (Objc.invoke Objc.tag_unit o (Selector.find "displayRect:")[(*NSRect*) unsupported rect]) : unit)

*)
(*  UNSUPPORTED
   method displayIfNeededInRect (rect : (*NSRect*) unsupported) =
     (get_unit (Objc.invoke Objc.tag_unit o (Selector.find "displayIfNeededInRect:")[(*NSRect*) unsupported rect]) : unit)

*)
   (* skipping selector displayRectIgnoringOpacity *)
(*  UNSUPPORTED
   method displayIfNeededInRectIgnoringOpacity (rect : (*NSRect*) unsupported) =
     (get_unit (Objc.invoke Objc.tag_unit o (Selector.find "displayIfNeededInRectIgnoringOpacity:")[(*NSRect*) unsupported rect]) : unit)
...
(*  UNSUPPORTED
   method bitmapImageRepForCachingDisplayInRect (rect : (*NSRect*) unsupported) =
     (get_pointer (Objc.invoke Objc.tag_pointer o (Selector.find "bitmapImageRepForCachingDisplayInRect:")[(*NSRect*) unsupported rect]) : [`NSBitmapImageRep] Objc.nativeNSObject)
...
*)
   ...
   method allocateGState =
     (get_unit (Objc.invoke Objc.tag_unit o (Selector.find "allocateGState:")[]) : unit)
   method releaseGState =
     (get_unit (Objc.invoke Objc.tag_unit o (Selector.find "releaseGState:")[]) : unit)
   method setUpGState =
     (get_unit (Objc.invoke Objc.tag_unit o (Selector.find "setUpGState:")[]) : unit)
   method renewGState =
     (get_unit (Objc.invoke Objc.tag_unit o (Selector.find "renewGState:")[]) : unit)
(*  UNSUPPORTED
   method scrollPoint (aPoint : (*NSPoint*) unsupported) =
     (get_unit (Objc.invoke Objc.tag_unit o (Selector.find "scrollPoint:")[(*NSPoint*) unsupported aPoint]) : unit)

*)
(*  UNSUPPORTED
   method scrollRectToVisible (aRect : (*NSRect*) unsupported) =
     (get_bool (Objc.invoke Objc.tag_bool o (Selector.find "scrollRectToVisible:")[(*NSRect*) unsupported aRect]) : bool)
...
(*  UNSUPPORTED
   method adjustScroll (newVisible : (*NSRect*) unsupported) =
     ((*NSRect*) unsupported (Objc.invoke (*NSRect*) Objc.tag_unsupported o (Selector.find "adjustScroll:")[(*NSRect*) unsupported newVisible]) : (*NSRect*) unsupported)
...
(*  UNSUPPORTED
   method hitTest (aPoint : (*NSPoint*) unsupported) =
     (get_pointer (Objc.invoke Objc.tag_pointer o (Selector.find "hitTest:")[(*NSPoint*) unsupported aPoint]) : [`NSView] Objc.nativeNSObject)
...
*)
   method viewWithTag (aTag : int) =
     (get_pointer (Objc.invoke Objc.tag_pointer o (Selector.find "viewWithTag:")[make_int aTag]) : [`NSObject] Objc.nativeNSObject)
   method tag =
   ...
   method shouldDelayWindowOrderingForEvent (theEvent : [`NSEvent] Objc.t) =
     (get_bool (Objc.invoke Objc.tag_bool o (Selector.find "shouldDelayWindowOrderingForEvent:")[make_pointer_from_object theEvent]) : bool)
   method needsPanelToBecomeKey =
     (get_bool (Objc.invoke Objc.tag_bool o (Selector.find "needsPanelToBecomeKey:")[]) : bool)
   method mouseDownCanMoveWindow =
     (get_bool (Objc.invoke Objc.tag_bool o (Selector.find "mouseDownCanMoveWindow:")[]) : bool)
(*  UNSUPPORTED
...
(*  UNSUPPORTED
   method addTrackingRect  ~owner:(anObject : [`NSObject] Objc.t ) ~userData:(data : [`void] Objc.t ) ~assumeInside:(flag : bool ) (aRect : (*NSRect*) unsupported) =
     let sel, args = (
       ...
       ((*NSTrackingRectTag*) unsupported (Objc.invoke (*NSTrackingRectTag*) Objc.tag_unsupported o (Selector.find_list sel) args) : (*NSTrackingRectTag*) unsupported)

*)
(*  UNSUPPORTED
   method removeTrackingRect (tag : (*NSTrackingRectTag*) unsupported) =
     (get_unit (Objc.invoke Objc.tag_unit o (Selector.find "removeTrackingRect:")[(*NSTrackingRectTag*) unsupported tag]) : unit)

*)
   method shouldDrawColor =
     (get_bool (Objc.invoke Objc.tag_bool o (Selector.find "shouldDrawColor:")[]) : bool)
   method setPostsBoundsChangedNotifications (flag : bool) =
     (get_unit (Objc.invoke Objc.tag_unit o (Selector.find "setPostsBoundsChangedNotifications:")[make_bool flag]) : unit)
   method postsBoundsChangedNotifications =
     (get_bool (Objc.invoke Objc.tag_bool o (Selector.find "postsBoundsChangedNotifications:")[]) : bool)
   method enclosingScrollView =
     (get_pointer (Objc.invoke Objc.tag_pointer o (Selector.find "enclosingScrollView:")[]) : [`NSScrollView] Objc.nativeNSObject)
   method menuForEvent (event : [`NSEvent] Objc.t) =
     (get_pointer (Objc.invoke Objc.tag_pointer o (Selector.find "menuForEvent:")[make_pointer_from_object event]) : [`NSMenu] Objc.nativeNSObject)
   method setToolTip (string : [`NSString] Objc.t) =
     (get_unit (Objc.invoke Objc.tag_unit o (Selector.find "setToolTip:")[make_pointer_from_object string]) : unit)
   method toolTip =
...
(*  UNSUPPORTED
   method addToolTipRect  ~owner:(anObject : [`NSObject] Objc.t ) ~userData:(data : [`void] Objc.t ) (aRect : (*NSRect*) unsupported) =
     let sel, args = (
       ...
       ((*NSToolTipTag*) unsupported (Objc.invoke (*NSToolTipTag*) Objc.tag_unsupported o (Selector.find_list sel) args) : (*NSToolTipTag*) unsupported)

*)
(*  UNSUPPORTED
   method removeToolTip (tag : (*NSToolTipTag*) unsupported) =
     (get_unit (Objc.invoke Objc.tag_unit o (Selector.find "removeToolTip:")[(*NSToolTipTag*) unsupported tag]) : unit)

*)
   method removeAllToolTips =
     (get_unit (Objc.invoke Objc.tag_unit o (Selector.find "removeAllToolTips:")[]) : unit)
   method viewWillStartLiveResize =
     (get_unit (Objc.invoke Objc.tag_unit o (Selector.find "viewWillStartLiveResize:")[]) : unit)
   method viewDidEndLiveResize =
     (get_unit (Objc.invoke Objc.tag_unit o (Selector.find "viewDidEndLiveResize:")[]) : unit)
   method inLiveResize =
     (get_bool (Objc.invoke Objc.tag_bool o (Selector.find "inLiveResize:")[]) : bool)
...
(*  UNSUPPORTED
   method rectPreservedDuringLiveResize =
     ((*NSRect*) unsupported (Objc.invoke (*NSRect*) Objc.tag_unsupported o (Selector.find "rectPreservedDuringLiveResize:")[]) : (*NSRect*) unsupported)
