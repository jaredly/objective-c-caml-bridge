...
let _ = init()
let make_NSObject_of_NSDocument (o : [`NSDocument] nativeNSObject) = (Obj.magic o : [`NSObject] nativeNSObject)
...
(* methods for category NSDeprecated *)
   method readableTypes =
     (get_pointer (Objc.invoke Objc.tag_pointer repr (Selector.find "readableTypes:")[]) : [`NSArray] Objc.nativeNSObject)
   method writableTypes =
     (get_pointer (Objc.invoke Objc.tag_pointer repr (Selector.find "writableTypes:")[]) : [`NSArray] Objc.nativeNSObject)
   method isNativeType (_type : [`NSString] Objc.t) =
     (get_pointer (Objc.invoke Objc.tag_pointer repr (Selector.find "isNativeType:")[make_pointer_from_object _type]) : [`NSDocument] Objc.nativeNSObject)
end
(* Encapsulation for native instance of NSDocument *)
class native_NSDocument = fun (o : [`NSDocument] nativeNSObject) -> object (self)
   inherit native_NSObject (make_NSObject_of_NSDocument o) as super
(* methods for category NSDeprecated *)
   method dataRepresentationOfType (_type : [`NSString] Objc.t) =
     (get_pointer (Objc.invoke Objc.tag_pointer repr (Selector.find "dataRepresentationOfType:")[make_pointer_from_object _type]) : [`NSData] Objc.nativeNSObject)
   ...
   method fileWrapperRepresentationOfType (_type : [`NSString] Objc.t) =
     (get_pointer (Objc.invoke Objc.tag_pointer repr (Selector.find "fileWrapperRepresentationOfType:")[make_pointer_from_object _type]) : [`NSFileWrapper] Objc.nativeNSObject)
   ...
   method printShowingPrintPanel (flag : bool) =
     (get_unit (Objc.invoke Objc.tag_unit repr (Selector.find "printShowingPrintPanel:")[make_bool flag]) : unit)
   ...
   method setFileType (typeName : [`NSString] Objc.t) =
     (get_unit (Objc.invoke Objc.tag_unit repr (Selector.find "setFileType:")[make_pointer_from_object typeName]) : unit)
   method fileType =
   ...
   method setFileURL (absoluteURL : [`NSURL] Objc.t) =
     (get_unit (Objc.invoke Objc.tag_unit repr (Selector.find "setFileURL:")[make_pointer_from_object absoluteURL]) : unit)
   method fileURL =
     (get_pointer (Objc.invoke Objc.tag_pointer repr (Selector.find "fileURL:")[]) : [`NSURL] Objc.nativeNSObject)
   method setFileModificationDate (modificationDate : [`NSDate] Objc.t) =
     (get_unit (Objc.invoke Objc.tag_unit repr (Selector.find "setFileModificationDate:")[make_pointer_from_object modificationDate]) : unit)
...
(*  UNSUPPORTED
   method revertDocumentToSaved (sender : [`NSObject] Objc.t) =
     ((*IBAction*) unsupported (Objc.invoke (*IBAction*) Objc.tag_unsupported repr (Selector.find "revertDocumentToSaved:")[make_pointer_from_object sender]) : (*IBAction*) unsupported)
...
*)
   ...
   method fileWrapperOfType  ~error:(outError : bool ) (typeName : [`NSString] Objc.t) =
     let sel, args = (
       ...
       (get_pointer (Objc.invoke Objc.tag_pointer repr (Selector.find_list sel) args) : [`NSFileWrapper] Objc.nativeNSObject)
   ...
   method keepBackupFile =
     (get_bool (Objc.invoke Objc.tag_bool repr (Selector.find "keepBackupFile:")[]) : bool)
(*  UNSUPPORTED
   method saveDocument (sender : [`NSObject] Objc.t) =
     ((*IBAction*) unsupported (Objc.invoke (*IBAction*) Objc.tag_unsupported repr (Selector.find "saveDocument:")[make_pointer_from_object sender]) : (*IBAction*) unsupported)

*)
(*  UNSUPPORTED
   method saveDocumentAs (sender : [`NSObject] Objc.t) =
     ((*IBAction*) unsupported (Objc.invoke (*IBAction*) Objc.tag_unsupported repr (Selector.find "saveDocumentAs:")[make_pointer_from_object sender]) : (*IBAction*) unsupported)

*)
(*  UNSUPPORTED
   method saveDocumentTo (sender : [`NSObject] Objc.t) =
     ((*IBAction*) unsupported (Objc.invoke (*IBAction*) Objc.tag_unsupported repr (Selector.find "saveDocumentTo:")[make_pointer_from_object sender]) : (*IBAction*) unsupported)
...
*)
   ...
   method shouldRunSavePanelWithAccessoryView =
     (get_bool (Objc.invoke Objc.tag_bool repr (Selector.find "shouldRunSavePanelWithAccessoryView:")[]) : bool)
   method prepareSavePanel (savePanel : [`NSSavePanel] Objc.t) =
     (get_bool (Objc.invoke Objc.tag_bool repr (Selector.find "prepareSavePanel:")[make_pointer_from_object savePanel]) : bool)
   method fileNameExtensionWasHiddenInLastRunSavePanel =
     (get_bool (Objc.invoke Objc.tag_bool repr (Selector.find "fileNameExtensionWasHiddenInLastRunSavePanel:")[]) : bool)
   method fileTypeFromLastRunSavePanel =
     (get_pointer (Objc.invoke Objc.tag_pointer repr (Selector.find "fileTypeFromLastRunSavePanel:")[]) : [`NSString] Objc.nativeNSObject)
   ...
   method hasUnautosavedChanges =
     (get_bool (Objc.invoke Objc.tag_bool repr (Selector.find "hasUnautosavedChanges:")[]) : bool)
   ...
   method autosavingFileType =
     (get_pointer (Objc.invoke Objc.tag_pointer repr (Selector.find "autosavingFileType:")[]) : [`NSString] Objc.nativeNSObject)
   method setAutosavedContentsFileURL (absoluteURL : [`NSURL] Objc.t) =
     (get_unit (Objc.invoke Objc.tag_unit repr (Selector.find "setAutosavedContentsFileURL:")[make_pointer_from_object absoluteURL]) : unit)
   method autosavedContentsFileURL =
     (get_pointer (Objc.invoke Objc.tag_pointer repr (Selector.find "autosavedContentsFileURL:")[]) : [`NSURL] Objc.nativeNSObject)
...
(*  UNSUPPORTED
   method runPageLayout (sender : [`NSObject] Objc.t) =
     ((*IBAction*) unsupported (Objc.invoke (*IBAction*) Objc.tag_unsupported repr (Selector.find "runPageLayout:")[make_pointer_from_object sender]) : (*IBAction*) unsupported)
...
*)
   ...
   method preparePageLayout (pageLayout : [`NSPageLayout] Objc.t) =
     (get_bool (Objc.invoke Objc.tag_bool repr (Selector.find "preparePageLayout:")[make_pointer_from_object pageLayout]) : bool)
   method shouldChangePrintInfo (newPrintInfo : [`NSPrintInfo] Objc.t) =
     (get_bool (Objc.invoke Objc.tag_bool repr (Selector.find "shouldChangePrintInfo:")[make_pointer_from_object newPrintInfo]) : bool)
   method setPrintInfo (printInfo : [`NSPrintInfo] Objc.t) =
     (get_unit (Objc.invoke Objc.tag_unit repr (Selector.find "setPrintInfo:")[make_pointer_from_object printInfo]) : unit)
   method printInfo =
...
(*  UNSUPPORTED
   method printDocument (sender : [`NSObject] Objc.t) =
     ((*IBAction*) unsupported (Objc.invoke (*IBAction*) Objc.tag_unsupported repr (Selector.find "printDocument:")[make_pointer_from_object sender]) : (*IBAction*) unsupported)
...
*)
   ...
   method updateChangeCount (change : int) =
     (get_unit (Objc.invoke Objc.tag_unit repr (Selector.find "updateChangeCount:")[make_int change]) : unit)
   method undoManager =
   ...
   method setUndoManager (undoManager : [`NSUndoManager] Objc.t) =
     (get_unit (Objc.invoke Objc.tag_unit repr (Selector.find "setUndoManager:")[make_pointer_from_object undoManager]) : unit)
   method hasUndoManager =
     (get_bool (Objc.invoke Objc.tag_bool repr (Selector.find "hasUndoManager:")[]) : bool)
   method setHasUndoManager (flag : bool) =
     (get_unit (Objc.invoke Objc.tag_unit repr (Selector.find "setHasUndoManager:")[make_bool flag]) : unit)
   ...
   method windowControllers =
     (get_pointer (Objc.invoke Objc.tag_pointer repr (Selector.find "windowControllers:")[]) : [`NSArray] Objc.nativeNSObject)
   method addWindowController (windowController : [`NSWindowController] Objc.t) =
     (get_unit (Objc.invoke Objc.tag_unit repr (Selector.find "addWindowController:")[make_pointer_from_object windowController]) : unit)
   method removeWindowController (windowController : [`NSWindowController] Objc.t) =
     (get_unit (Objc.invoke Objc.tag_unit repr (Selector.find "removeWindowController:")[make_pointer_from_object windowController]) : unit)
   ...
   method makeWindowControllers =
     (get_unit (Objc.invoke Objc.tag_unit repr (Selector.find "makeWindowControllers:")[]) : unit)
   method showWindows =
     (get_unit (Objc.invoke Objc.tag_unit repr (Selector.find "showWindows:")[]) : unit)
   ...
   method windowControllerWillLoadNib (windowController : [`NSWindowController] Objc.t) =
     (get_unit (Objc.invoke Objc.tag_unit repr (Selector.find "windowControllerWillLoadNib:")[make_pointer_from_object windowController]) : unit)
   method windowControllerDidLoadNib (windowController : [`NSWindowController] Objc.t) =
     (get_unit (Objc.invoke Objc.tag_unit repr (Selector.find "windowControllerDidLoadNib:")[make_pointer_from_object windowController]) : unit)
   method displayName =
   ...
   method windowForSheet =
     (get_pointer (Objc.invoke Objc.tag_pointer repr (Selector.find "windowForSheet:")[]) : [`NSWindow] Objc.nativeNSObject)
   method writableTypesForSaveOperation (saveOperation : int) =
     (get_pointer (Objc.invoke Objc.tag_pointer repr (Selector.find "writableTypesForSaveOperation:")[make_int saveOperation]) : [`NSArray] Objc.nativeNSObject)
