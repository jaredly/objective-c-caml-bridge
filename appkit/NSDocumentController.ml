...
let class_NSDocumentController = object
   val o = Classes.find "NSDocumentController"
   method _new = (Objc.objcnew o : [`NSDocumentController] nativeNSObject)
(* methods for category NSDeprecated *)
   method sharedDocumentController =
     (get_pointer (Objc.invoke Objc.tag_pointer o (Selector.find "sharedDocumentController:")[]) : [`NSDocumentController] Objc.nativeNSObject)
end
...
(* methods for category NSDeprecated *)
   method documentForFileName (fileName : [`NSString] Objc.t) =
     (get_pointer (Objc.invoke Objc.tag_pointer o (Selector.find "documentForFileName:")[make_pointer_from_object fileName]) : [`NSObject] Objc.nativeNSObject)
   method fileNamesFromRunningOpenPanel =
     (get_pointer (Objc.invoke Objc.tag_pointer o (Selector.find "fileNamesFromRunningOpenPanel:")[]) : [`NSArray] Objc.nativeNSObject)
   ...
   method setShouldCreateUI (flag : bool) =
     (get_unit (Objc.invoke Objc.tag_unit o (Selector.find "setShouldCreateUI:")[make_bool flag]) : unit)
   method shouldCreateUI =
     (get_bool (Objc.invoke Objc.tag_bool o (Selector.find "shouldCreateUI:")[]) : bool)
   method init =
     (get_pointer (Objc.invoke Objc.tag_pointer o (Selector.find "init:")[]) : [`NSObject] Objc.nativeNSObject)
   method documents =
     (get_pointer (Objc.invoke Objc.tag_pointer o (Selector.find "documents:")[]) : [`NSArray] Objc.nativeNSObject)
   method currentDocument =
     (get_pointer (Objc.invoke Objc.tag_pointer o (Selector.find "currentDocument:")[]) : [`NSObject] Objc.nativeNSObject)
   method currentDirectory =
     (get_pointer (Objc.invoke Objc.tag_pointer o (Selector.find "currentDirectory:")[]) : [`NSString] Objc.nativeNSObject)
   method documentForURL (absoluteURL : [`NSURL] Objc.t) =
     (get_pointer (Objc.invoke Objc.tag_pointer o (Selector.find "documentForURL:")[make_pointer_from_object absoluteURL]) : [`NSObject] Objc.nativeNSObject)
   method documentForWindow (window : [`NSWindow] Objc.t) =
     (get_pointer (Objc.invoke Objc.tag_pointer o (Selector.find "documentForWindow:")[make_pointer_from_object window]) : [`NSObject] Objc.nativeNSObject)
   method addDocument (document : [`NSDocument] Objc.t) =
     (get_unit (Objc.invoke Objc.tag_unit o (Selector.find "addDocument:")[make_pointer_from_object document]) : unit)
   method removeDocument (document : [`NSDocument] Objc.t) =
     (get_unit (Objc.invoke Objc.tag_unit o (Selector.find "removeDocument:")[make_pointer_from_object document]) : unit)
(*  UNSUPPORTED
   method newDocument (sender : [`NSObject] Objc.t) =
     ((*IBAction*) unsupported (Objc.invoke (*IBAction*) Objc.tag_unsupported o (Selector.find "newDocument:")[make_pointer_from_object sender]) : (*IBAction*) unsupported)
...
(*  UNSUPPORTED
   method openDocument (sender : [`NSObject] Objc.t) =
     ((*IBAction*) unsupported (Objc.invoke (*IBAction*) Objc.tag_unsupported o (Selector.find "openDocument:")[make_pointer_from_object sender]) : (*IBAction*) unsupported)

*)
   method l_URLsFromRunningOpenPanel =
     (get_pointer (Objc.invoke Objc.tag_pointer o (Selector.find "l_URLsFromRunningOpenPanel:")[]) : [`NSArray] Objc.nativeNSObject)
   ...
   method setAutosavingDelay (autosavingDelay : float) =
     (get_unit (Objc.invoke Objc.tag_unit o (Selector.find "setAutosavingDelay:")[make_float autosavingDelay]) : unit)
   method autosavingDelay =
     (get_float (Objc.invoke Objc.tag_float o (Selector.find "autosavingDelay:")[]) : float)
(*  UNSUPPORTED
   method saveAllDocuments (sender : [`NSObject] Objc.t) =
     ((*IBAction*) unsupported (Objc.invoke (*IBAction*) Objc.tag_unsupported o (Selector.find "saveAllDocuments:")[make_pointer_from_object sender]) : (*IBAction*) unsupported)

*)
   method hasEditedDocuments =
     (get_bool (Objc.invoke Objc.tag_bool o (Selector.find "hasEditedDocuments:")[]) : bool)
   ...
   method maximumRecentDocumentCount =
     (get_int (Objc.invoke Objc.tag_int o (Selector.find "maximumRecentDocumentCount:")[]) : int)
(*  UNSUPPORTED
   method clearRecentDocuments (sender : [`NSObject] Objc.t) =
     ((*IBAction*) unsupported (Objc.invoke (*IBAction*) Objc.tag_unsupported o (Selector.find "clearRecentDocuments:")[make_pointer_from_object sender]) : (*IBAction*) unsupported)

*)
   method noteNewRecentDocument (document : [`NSDocument] Objc.t) =
     (get_unit (Objc.invoke Objc.tag_unit o (Selector.find "noteNewRecentDocument:")[make_pointer_from_object document]) : unit)
   method noteNewRecentDocumentURL (absoluteURL : [`NSURL] Objc.t) =
     (get_unit (Objc.invoke Objc.tag_unit o (Selector.find "noteNewRecentDocumentURL:")[make_pointer_from_object absoluteURL]) : unit)
   method recentDocumentURLs =
     (get_pointer (Objc.invoke Objc.tag_pointer o (Selector.find "recentDocumentURLs:")[]) : [`NSArray] Objc.nativeNSObject)
   method defaultType =
     (get_pointer (Objc.invoke Objc.tag_pointer o (Selector.find "defaultType:")[]) : [`NSString] Objc.nativeNSObject)
   ...
   method documentClassNames =
     (get_pointer (Objc.invoke Objc.tag_pointer o (Selector.find "documentClassNames:")[]) : [`NSArray] Objc.nativeNSObject)
   method typeFromFileExtension (fileNameExtensionOrHFSFileType : [`NSString] Objc.t) =
     (get_pointer (Objc.invoke Objc.tag_pointer o (Selector.find "typeFromFileExtension:")[make_pointer_from_object fileNameExtensionOrHFSFileType]) : [`NSString] Objc.nativeNSObject)
   method documentClassForType (typeName : [`NSString] Objc.t) =
     (get_pointer (Objc.invoke Objc.tag_pointer o (Selector.find "documentClassForType:")[make_pointer_from_object typeName]) : [`NSObject] Objc.nativeNSObject)
   method displayNameForType (typeName : [`NSString] Objc.t) =
     (get_pointer (Objc.invoke Objc.tag_pointer o (Selector.find "displayNameForType:")[make_pointer_from_object typeName]) : [`NSString] Objc.nativeNSObject)
   method fileExtensionsFromType (typeName : [`NSString] Objc.t) =
     (get_pointer (Objc.invoke Objc.tag_pointer o (Selector.find "fileExtensionsFromType:")[make_pointer_from_object typeName]) : [`NSArray] Objc.nativeNSObject)
