...
let _ = init()
let make_NSControl_of_NSMatrix (o : [`NSMatrix] nativeNSObject) = (Obj.magic o : [`NSControl] nativeNSObject)
(* Class object for NSMatrix *)
let class_NSMatrix = object
   val repr = Classes.find "NSMatrix"
   method _new = (Objc.objcnew repr : [`NSMatrix] nativeNSObject)
   method _alloc = (Objc.objcalloc repr : [`NSMatrix] nativeNSObject)
...
class native_NSMatrix = fun (o : [`NSMatrix] nativeNSObject) -> object (self)
   inherit native_NSControl (make_NSControl_of_NSMatrix o) as super
(* methods for category NSKeyboardUI *)
   method setTabKeyTraversesCells (flag : bool) =
     (get_unit (Objc.invoke Objc.tag_unit repr (Selector.find "setTabKeyTraversesCells:")[make_bool flag]) : unit)
   method tabKeyTraversesCells =
     (get_bool (Objc.invoke Objc.tag_bool repr (Selector.find "tabKeyTraversesCells:")[]) : bool)
   method setKeyCell (keyCell : [`NSCell] Objc.t) =
     (get_unit (Objc.invoke Objc.tag_unit repr (Selector.find "setKeyCell:")[make_pointer_from_object keyCell]) : unit)
   method keyCell =
     (get_pointer (Objc.invoke Objc.tag_pointer repr (Selector.find "keyCell:")[]) : [`NSObject] Objc.nativeNSObject)
...
*)
   ...
   method cellClass =
     (get_pointer (Objc.invoke Objc.tag_pointer repr (Selector.find "cellClass:")[]) : [`NSObject] Objc.nativeNSObject)
   method prototype =
     (get_pointer (Objc.invoke Objc.tag_pointer repr (Selector.find "prototype:")[]) : [`NSObject] Objc.nativeNSObject)
   method setPrototype (aCell : [`NSCell] Objc.t) =
     (get_unit (Objc.invoke Objc.tag_unit repr (Selector.find "setPrototype:")[make_pointer_from_object aCell]) : unit)
   method makeCellAtRow  ~column:(col : int ) (row : int) =
     let sel, args = (
       Objc.arg row "makeCellAtRow" make_int
       ++ Objc.arg col "column" make_int
     ) ([],[]) in
       (get_pointer (Objc.invoke Objc.tag_pointer repr (Selector.find_list sel) args) : [`NSCell] Objc.nativeNSObject)
   method mode =
     (get_int (Objc.invoke Objc.tag_int repr (Selector.find "mode:")[]) : int)
   method setMode (aMode : int) =
     (get_unit (Objc.invoke Objc.tag_unit repr (Selector.find "setMode:")[make_int aMode]) : unit)
...
*)
   method cells =
     (get_pointer (Objc.invoke Objc.tag_pointer repr (Selector.find "cells:")[]) : [`NSArray] Objc.nativeNSObject)
...
*)
   ...
   method setSelectionByRect (flag : bool) =
     (get_unit (Objc.invoke Objc.tag_unit repr (Selector.find "setSelectionByRect:")[make_bool flag]) : unit)
   method isSelectionByRect =
     (get_bool (Objc.invoke Objc.tag_bool repr (Selector.find "isSelectionByRect:")[]) : bool)
   ...
   method deselectSelectedCell =
     (get_unit (Objc.invoke Objc.tag_unit repr (Selector.find "deselectSelectedCell:")[]) : unit)
   method deselectAllCells =
     (get_unit (Objc.invoke Objc.tag_unit repr (Selector.find "deselectAllCells:")[]) : unit)
   ...
   method selectCellWithTag (anInt : int) =
     (get_bool (Objc.invoke Objc.tag_bool repr (Selector.find "selectCellWithTag:")[make_int anInt]) : bool)
(*  UNSUPPORTED
   method cellSize =
...
(*  UNSUPPORTED
   method setCellSize (aSize : (*NSSize*) unsupported) =
     (get_unit (Objc.invoke Objc.tag_unit repr (Selector.find "setCellSize:")[(*NSSize*) unsupported aSize]) : unit)
...
*)
   ...
   method setCellBackgroundColor (color : [`NSColor] Objc.t) =
     (get_unit (Objc.invoke Objc.tag_unit repr (Selector.find "setCellBackgroundColor:")[make_pointer_from_object color]) : unit)
   method cellBackgroundColor =
     (get_pointer (Objc.invoke Objc.tag_pointer repr (Selector.find "cellBackgroundColor:")[]) : [`NSColor] Objc.nativeNSObject)
   method setDrawsCellBackground (flag : bool) =
     (get_unit (Objc.invoke Objc.tag_unit repr (Selector.find "setDrawsCellBackground:")[make_bool flag]) : unit)
   method drawsCellBackground =
     (get_bool (Objc.invoke Objc.tag_bool repr (Selector.find "drawsCellBackground:")[]) : bool)
...
*)
   ...
   method putCell  ~atRow:(row : int ) ~column:(col : int ) (newCell : [`NSCell] Objc.t) =
     let sel, args = (
       ...
       (get_unit (Objc.invoke Objc.tag_unit repr (Selector.find_list sel) args) : unit)
   method addRow =
     (get_unit (Objc.invoke Objc.tag_unit repr (Selector.find "addRow:")[]) : unit)
   method addRowWithCells (newCells : [`NSArray] Objc.t) =
     (get_unit (Objc.invoke Objc.tag_unit repr (Selector.find "addRowWithCells:")[make_pointer_from_object newCells]) : unit)
   ...
   method removeRow (row : int) =
     (get_unit (Objc.invoke Objc.tag_unit repr (Selector.find "removeRow:")[make_int row]) : unit)
   method addColumn =
     (get_unit (Objc.invoke Objc.tag_unit repr (Selector.find "addColumn:")[]) : unit)
   method addColumnWithCells (newCells : [`NSArray] Objc.t) =
     (get_unit (Objc.invoke Objc.tag_unit repr (Selector.find "addColumnWithCells:")[make_pointer_from_object newCells]) : unit)
   ...
   method removeColumn (col : int) =
     (get_unit (Objc.invoke Objc.tag_unit repr (Selector.find "removeColumn:")[make_int col]) : unit)
   method cellWithTag (anInt : int) =
     (get_pointer (Objc.invoke Objc.tag_pointer repr (Selector.find "cellWithTag:")[make_int anInt]) : [`NSObject] Objc.nativeNSObject)
   method doubleAction =
   ...
   method setAutosizesCells (flag : bool) =
     (get_unit (Objc.invoke Objc.tag_unit repr (Selector.find "setAutosizesCells:")[make_bool flag]) : unit)
   method autosizesCells =
     (get_bool (Objc.invoke Objc.tag_bool repr (Selector.find "autosizesCells:")[]) : bool)
   method sizeToCells =
     (get_unit (Objc.invoke Objc.tag_unit repr (Selector.find "sizeToCells:")[]) : unit)
   method setValidateSize (flag : bool) =
     (get_unit (Objc.invoke Objc.tag_unit repr (Selector.find "setValidateSize:")[make_bool flag]) : unit)
   ...
   method setAutoscroll (flag : bool) =
     (get_unit (Objc.invoke Objc.tag_unit repr (Selector.find "setAutoscroll:")[make_bool flag]) : unit)
   method isAutoscroll =
     (get_bool (Objc.invoke Objc.tag_bool repr (Selector.find "isAutoscroll:")[]) : bool)
   ...
   method sendDoubleAction =
     (get_unit (Objc.invoke Objc.tag_unit repr (Selector.find "sendDoubleAction:")[]) : unit)
   method delegate =
...
*)
   method toolTipForCell (cell : [`NSCell] Objc.t) =
     (get_pointer (Objc.invoke Objc.tag_pointer repr (Selector.find "toolTipForCell:")[make_pointer_from_object cell]) : [`NSString] Objc.nativeNSObject)
end
