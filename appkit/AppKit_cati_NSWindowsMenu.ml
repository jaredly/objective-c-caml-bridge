...
class virtual methods_NSApplication = object (self)
  ...
  method addWindowsItem_title_filename  (win : [`NSWindow] Objc.t) (aString : [`NSString] Objc.t) (isFilename : bool) =
    let sel, args = (
      ...
      (get_unit (Objc.invoke Objc.tag_unit self#repr (Selector.find_list sel) args)
       : unit)
  method changeWindowsItem_title_filename  (win : [`NSWindow] Objc.t) (aString : [`NSString] Objc.t) (isFilename : bool) =
    let sel, args = (
