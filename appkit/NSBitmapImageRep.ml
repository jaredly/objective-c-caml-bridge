...
let class_NSBitmapImageRep = object
   val o = Classes.find "NSBitmapImageRep"
   method _new = (Objc.objcnew o : [`NSBitmapImageRep] nativeNSObject)
...
(* methods for category NSWindowsExtensions *)
   method imageRepsWithData (tiffData : [`NSData] Objc.t) =
     (get_pointer (Objc.invoke Objc.tag_pointer o (Selector.find "imageRepsWithData:")[make_pointer_from_object tiffData]) : [`NSArray] Objc.nativeNSObject)
   method imageRepWithData (tiffData : [`NSData] Objc.t) =
     (get_pointer (Objc.invoke Objc.tag_pointer o (Selector.find "imageRepWithData:")[make_pointer_from_object tiffData]) : [`NSBitmapImageRep] Objc.nativeNSObject)
...
(*  UNSUPPORTED
   method getTIFFCompressionTypes  ~count:(numTypes : [`int] Objc.t ) (list : (*pointer to pointer to const NSTIFFCompression*) unsupported) =
     let sel, args = (
       ...
       (get_pointer (Objc.invoke Objc.tag_pointer o (Selector.find_list sel) args) : [`NSBitmapImageRep] Objc.nativeNSObject)

*)
   method localizedNameForTIFFCompressionType (compression : int) =
     (get_pointer (Objc.invoke Objc.tag_pointer o (Selector.find "localizedNameForTIFFCompressionType:")[make_int compression]) : [`NSString] Objc.nativeNSObject)
end
...
(* methods for category NSBitmapImageFileTypeExtensions *)
   ...
   method valueForProperty (property : [`NSString] Objc.t) =
     (get_pointer (Objc.invoke Objc.tag_pointer o (Selector.find "valueForProperty:")[make_pointer_from_object property]) : [`NSObject] Objc.nativeNSObject)
(* methods for category NSWindowsExtensions *)
...
(*  UNSUPPORTED
   method initWithFocusedViewRect (rect : (*NSRect*) unsupported) =
     (get_pointer (Objc.invoke Objc.tag_pointer o (Selector.find "initWithFocusedViewRect:")[(*NSRect*) unsupported rect]) : [`NSObject] Objc.nativeNSObject)
...
*)
   method initWithData (tiffData : [`NSData] Objc.t) =
     (get_pointer (Objc.invoke Objc.tag_pointer o (Selector.find "initWithData:")[make_pointer_from_object tiffData]) : [`NSObject] Objc.nativeNSObject)
(*  UNSUPPORTED
   method bitmapData =
     ((*pointer to unsigned char*) unsupported (Objc.invoke (*pointer to unsigned char*) Objc.tag_unsupported o (Selector.find "bitmapData:")[]) : (*pointer to unsigned char*) unsupported)

*)
(*  UNSUPPORTED
   method getBitmapDataPlanes (data : (*pointer to pointer to unsigned char*) unsupported) =
     (get_unit (Objc.invoke Objc.tag_unit o (Selector.find "getBitmapDataPlanes:")[(*pointer to pointer to unsigned char*) unsupported data]) : unit)

*)
   method isPlanar =
     (get_bool (Objc.invoke Objc.tag_bool o (Selector.find "isPlanar:")[]) : bool)
   method samplesPerPixel =
     (get_int (Objc.invoke Objc.tag_int o (Selector.find "samplesPerPixel:")[]) : int)
   method bitsPerPixel =
     (get_int (Objc.invoke Objc.tag_int o (Selector.find "bitsPerPixel:")[]) : int)
   method bytesPerRow =
     (get_int (Objc.invoke Objc.tag_int o (Selector.find "bytesPerRow:")[]) : int)
   method bytesPerPlane =
     (get_int (Objc.invoke Objc.tag_int o (Selector.find "bytesPerPlane:")[]) : int)
   method numberOfPlanes =
     (get_int (Objc.invoke Objc.tag_int o (Selector.find "numberOfPlanes:")[]) : int)
   method bitmapFormat =
     (get_int (Objc.invoke Objc.tag_int o (Selector.find "bitmapFormat:")[]) : int)
   ...
   method canBeCompressedUsing (compression : int) =
     (get_bool (Objc.invoke Objc.tag_bool o (Selector.find "canBeCompressedUsing:")[make_int compression]) : bool)
   ...
   method initForIncrementalLoad =
     (get_pointer (Objc.invoke Objc.tag_pointer o (Selector.find "initForIncrementalLoad:")[]) : [`NSObject] Objc.nativeNSObject)
