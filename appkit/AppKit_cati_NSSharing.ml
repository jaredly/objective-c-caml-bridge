...
class virtual methods_NSTextView = object (self)
  ...
  method selectedRanges =
    ((get_pointer (Objc.invoke Objc.tag_pointer self#repr (Selector.find "selectedRanges")[])
       : [`NSArray] Objc.id))
  method setSelectedRanges_affinity_stillSelecting  (ranges : [`NSArray] Objc.t) (affinity : int) (stillSelectingFlag : bool) =
    let sel, args = (
      Objc.arg ranges "setSelectedRanges" make_pointer_from_object
      ++ Objc.arg affinity "affinity" make_int
      ++ Objc.arg stillSelectingFlag "stillSelecting" make_bool
    ) ([],[]) in
      (get_unit (Objc.invoke Objc.tag_unit self#repr (Selector.find_list sel) args)
       : unit)
  method setSelectedRanges (ranges : [`NSArray] Objc.t) =
    (get_unit (Objc.invoke Objc.tag_unit self#repr (Selector.find "setSelectedRanges:")
      [make_pointer_from_object ranges]) : unit)
  method setSelectedRange_affinity_stillSelecting  (charRange : NSRange.t) (affinity : int) (stillSelectingFlag : bool) =
    let sel, args = (
  ...
  method shouldChangeTextInRanges_replacementStrings  (affectedRanges : [`NSArray] Objc.t) (replacementStrings : [`NSArray] Objc.t) =
    let sel, args = (
  ...
  method rangesForUserParagraphAttributeChange =
    ((get_pointer (Objc.invoke Objc.tag_pointer self#repr (Selector.find "rangesForUserParagraphAttributeChange")[])
       : [`NSArray] Objc.id))
  method shouldChangeTextInRange_replacementString  (affectedCharRange : NSRange.t) (replacementString : [`NSString] Objc.t) =
    let sel, args = (
  ...
  method setSmartInsertDeleteEnabled (flag : bool) =
    (get_unit (Objc.invoke Objc.tag_unit self#repr (Selector.find "setSmartInsertDeleteEnabled:")
      [make_bool flag]) : unit)
  method smartDeleteRangeForProposedRange (proposedCharRange : NSRange.t) =
    (get_range (Objc.invoke Objc.tag_nsrange self#repr (Selector.find "smartDeleteRangeForProposedRange:")
      [make_range proposedCharRange]) : NSRange.t)
(*  UNSUPPORTED
  method smartInsertForString_replacingRange_beforeString_afterString  (pasteString : [`NSString] Objc.t) (charRangeToReplace : NSRange.t) (beforeString : (*pointer to pointer to NSString*) unsupported) (afterString : (*pointer to pointer to NSString*) unsupported) =
    let sel, args = (
...
*)
  method smartInsertBeforeStringForString_replacingRange  (pasteString : [`NSString] Objc.t) (charRangeToReplace : NSRange.t) =
    let sel, args = (
      ...
      ((get_pointer (Objc.invoke Objc.tag_pointer self#repr (Selector.find_list sel) args)
       : [`NSString] Objc.id))
  method smartInsertAfterStringForString_replacingRange  (pasteString : [`NSString] Objc.t) (charRangeToReplace : NSRange.t) =
    let sel, args = (
