...
*)
  method setUsesItemFromMenu (flag : bool) =
    (get_unit (Objc.invoke Objc.tag_unit self#repr (Selector.find "setUsesItemFromMenu:")
      [make_bool flag]) : unit)
  method usesItemFromMenu =
    (get_bool (Objc.invoke Objc.tag_bool self#repr (Selector.find "usesItemFromMenu")[])
       : bool)
  method setAltersStateOfSelectedItem (flag : bool) =
    (get_unit (Objc.invoke Objc.tag_unit self#repr (Selector.find "setAltersStateOfSelectedItem:")
      [make_bool flag]) : unit)
  method altersStateOfSelectedItem =
    (get_bool (Objc.invoke Objc.tag_bool self#repr (Selector.find "altersStateOfSelectedItem")[])
       : bool)
  ...
  method setArrowPosition (position : int) =
    (get_unit (Objc.invoke Objc.tag_unit self#repr (Selector.find "setArrowPosition:")
