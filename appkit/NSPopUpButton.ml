...
let _ = init()
let make_NSButton_of_NSPopUpButton (o : [`NSPopUpButton] nativeNSObject) = (Obj.magic o : [`NSButton] nativeNSObject)
(* Class object for NSPopUpButton *)
let class_NSPopUpButton = object
   val repr = Classes.find "NSPopUpButton"
   method _new = (Objc.objcnew repr : [`NSPopUpButton] nativeNSObject)
   method _alloc = (Objc.objcalloc repr : [`NSPopUpButton] nativeNSObject)
end
...
class native_NSPopUpButton = fun (o : [`NSPopUpButton] nativeNSObject) -> object (self)
   inherit native_NSButton (make_NSButton_of_NSPopUpButton o) as super
(*  UNSUPPORTED
