...
let class_NSOutlineView = object
   val o = Classes.find "NSOutlineView"
   method _new = (Objc.objcnew o : [`NSOutlineView] nativeNSObject)
end
...
class native_NSOutlineView = fun (o : [`NSOutlineView] nativeNSObject) -> object (self)
   ...
   method setOutlineTableColumn (outlineTableColumn : [`NSTableColumn] Objc.t) =
     (get_unit (Objc.invoke Objc.tag_unit o (Selector.find "setOutlineTableColumn:")[make_pointer_from_object outlineTableColumn]) : unit)
   method outlineTableColumn =
     (get_pointer (Objc.invoke Objc.tag_pointer o (Selector.find "outlineTableColumn:")[]) : [`NSTableColumn] Objc.nativeNSObject)
   method isExpandable (item : [`NSObject] Objc.t) =
     (get_bool (Objc.invoke Objc.tag_bool o (Selector.find "isExpandable:")[make_pointer_from_object item]) : bool)
   ...
   method itemAtRow (row : int) =
     (get_pointer (Objc.invoke Objc.tag_pointer o (Selector.find "itemAtRow:")[make_int row]) : [`NSObject] Objc.nativeNSObject)
   method rowForItem (item : [`NSObject] Objc.t) =
     (get_int (Objc.invoke Objc.tag_int o (Selector.find "rowForItem:")[make_pointer_from_object item]) : int)
   method levelForItem (item : [`NSObject] Objc.t) =
     (get_int (Objc.invoke Objc.tag_int o (Selector.find "levelForItem:")[make_pointer_from_object item]) : int)
   method levelForRow (row : int) =
     (get_int (Objc.invoke Objc.tag_int o (Selector.find "levelForRow:")[make_int row]) : int)
   method isItemExpanded (item : [`NSObject] Objc.t) =
     (get_bool (Objc.invoke Objc.tag_bool o (Selector.find "isItemExpanded:")[make_pointer_from_object item]) : bool)
   method setIndentationPerLevel (indentationPerLevel : float) =
     (get_unit (Objc.invoke Objc.tag_unit o (Selector.find "setIndentationPerLevel:")[make_float indentationPerLevel]) : unit)
   method indentationPerLevel =
     (get_float (Objc.invoke Objc.tag_float o (Selector.find "indentationPerLevel:")[]) : float)
   method setIndentationMarkerFollowsCell (drawInCell : bool) =
     (get_unit (Objc.invoke Objc.tag_unit o (Selector.find "setIndentationMarkerFollowsCell:")[make_bool drawInCell]) : unit)
   method indentationMarkerFollowsCell =
     (get_bool (Objc.invoke Objc.tag_bool o (Selector.find "indentationMarkerFollowsCell:")[]) : bool)
   method setAutoresizesOutlineColumn (resize : bool) =
     (get_unit (Objc.invoke Objc.tag_unit o (Selector.find "setAutoresizesOutlineColumn:")[make_bool resize]) : unit)
   method autoresizesOutlineColumn =
     (get_bool (Objc.invoke Objc.tag_bool o (Selector.find "autoresizesOutlineColumn:")[]) : bool)
   ...
   method shouldCollapseAutoExpandedItemsForDeposited (deposited : bool) =
     (get_bool (Objc.invoke Objc.tag_bool o (Selector.find "shouldCollapseAutoExpandedItemsForDeposited:")[make_bool deposited]) : bool)
   method autosaveExpandedItems =
     (get_bool (Objc.invoke Objc.tag_bool o (Selector.find "autosaveExpandedItems:")[]) : bool)
   method setAutosaveExpandedItems (save : bool) =
     (get_unit (Objc.invoke Objc.tag_unit o (Selector.find "setAutosaveExpandedItems:")[make_bool save]) : unit)
end
...
(* methods for category NSOutlineViewNotifications *)
   method outlineViewSelectionDidChange (notification : [`NSNotification] Objc.t) =
     (get_unit (Objc.invoke Objc.tag_unit o (Selector.find "outlineViewSelectionDidChange:")[make_pointer_from_object notification]) : unit)
   method outlineViewColumnDidMove (notification : [`NSNotification] Objc.t) =
     (get_unit (Objc.invoke Objc.tag_unit o (Selector.find "outlineViewColumnDidMove:")[make_pointer_from_object notification]) : unit)
   method outlineViewColumnDidResize (notification : [`NSNotification] Objc.t) =
     (get_unit (Objc.invoke Objc.tag_unit o (Selector.find "outlineViewColumnDidResize:")[make_pointer_from_object notification]) : unit)
   method outlineViewSelectionIsChanging (notification : [`NSNotification] Objc.t) =
     (get_unit (Objc.invoke Objc.tag_unit o (Selector.find "outlineViewSelectionIsChanging:")[make_pointer_from_object notification]) : unit)
   method outlineViewItemWillExpand (notification : [`NSNotification] Objc.t) =
     (get_unit (Objc.invoke Objc.tag_unit o (Selector.find "outlineViewItemWillExpand:")[make_pointer_from_object notification]) : unit)
   method outlineViewItemDidExpand (notification : [`NSNotification] Objc.t) =
     (get_unit (Objc.invoke Objc.tag_unit o (Selector.find "outlineViewItemDidExpand:")[make_pointer_from_object notification]) : unit)
   method outlineViewItemWillCollapse (notification : [`NSNotification] Objc.t) =
     (get_unit (Objc.invoke Objc.tag_unit o (Selector.find "outlineViewItemWillCollapse:")[make_pointer_from_object notification]) : unit)
   method outlineViewItemDidCollapse (notification : [`NSNotification] Objc.t) =
     (get_unit (Objc.invoke Objc.tag_unit o (Selector.find "outlineViewItemDidCollapse:")[make_pointer_from_object notification]) : unit)
(* methods for category NSOutlineViewDelegate *)
   ...
   method selectionShouldChangeInOutlineView (outlineView : [`NSOutlineView] Objc.t) =
     (get_bool (Objc.invoke Objc.tag_bool o (Selector.find "selectionShouldChangeInOutlineView:")[make_pointer_from_object outlineView]) : bool)
