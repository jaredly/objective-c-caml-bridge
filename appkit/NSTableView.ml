...
let class_NSTableView = object
   val o = Classes.find "NSTableView"
   method _new = (Objc.objcnew o : [`NSTableView] nativeNSObject)
end
...
class native_NSTableView = fun (o : [`NSTableView] nativeNSObject) -> object (self)
   ...
   method setHeaderView (headerView : [`NSTableHeaderView] Objc.t) =
     (get_unit (Objc.invoke Objc.tag_unit o (Selector.find "setHeaderView:")[make_pointer_from_object headerView]) : unit)
   method headerView =
     (get_pointer (Objc.invoke Objc.tag_pointer o (Selector.find "headerView:")[]) : [`NSTableHeaderView] Objc.nativeNSObject)
   method setCornerView (cornerView : [`NSView] Objc.t) =
     (get_unit (Objc.invoke Objc.tag_unit o (Selector.find "setCornerView:")[make_pointer_from_object cornerView]) : unit)
   method cornerView =
     (get_pointer (Objc.invoke Objc.tag_pointer o (Selector.find "cornerView:")[]) : [`NSView] Objc.nativeNSObject)
   method setAllowsColumnReordering (flag : bool) =
     (get_unit (Objc.invoke Objc.tag_unit o (Selector.find "setAllowsColumnReordering:")[make_bool flag]) : unit)
   method allowsColumnReordering =
     (get_bool (Objc.invoke Objc.tag_bool o (Selector.find "allowsColumnReordering:")[]) : bool)
   method setAllowsColumnResizing (flag : bool) =
     (get_unit (Objc.invoke Objc.tag_unit o (Selector.find "setAllowsColumnResizing:")[make_bool flag]) : unit)
   method allowsColumnResizing =
     (get_bool (Objc.invoke Objc.tag_bool o (Selector.find "allowsColumnResizing:")[]) : bool)
   method setColumnAutoresizingStyle (style : int) =
     (get_unit (Objc.invoke Objc.tag_unit o (Selector.find "setColumnAutoresizingStyle:")[make_int style]) : unit)
   method columnAutoresizingStyle =
     (get_int (Objc.invoke Objc.tag_int o (Selector.find "columnAutoresizingStyle:")[]) : int)
   method setGridStyleMask (gridType : int) =
     (get_unit (Objc.invoke Objc.tag_unit o (Selector.find "setGridStyleMask:")[make_int gridType]) : unit)
   method gridStyleMask =
     (get_int (Objc.invoke Objc.tag_int o (Selector.find "gridStyleMask:")[]) : int)
(*  UNSUPPORTED
...
*)
   method setUsesAlternatingRowBackgroundColors (useAlternatingRowColors : bool) =
     (get_unit (Objc.invoke Objc.tag_unit o (Selector.find "setUsesAlternatingRowBackgroundColors:")[make_bool useAlternatingRowColors]) : unit)
   method usesAlternatingRowBackgroundColors =
     (get_bool (Objc.invoke Objc.tag_bool o (Selector.find "usesAlternatingRowBackgroundColors:")[]) : bool)
   ...
   method setGridColor (color : [`NSColor] Objc.t) =
     (get_unit (Objc.invoke Objc.tag_unit o (Selector.find "setGridColor:")[make_pointer_from_object color]) : unit)
   method gridColor =
   ...
   method setRowHeight (rowHeight : float) =
     (get_unit (Objc.invoke Objc.tag_unit o (Selector.find "setRowHeight:")[make_float rowHeight]) : unit)
   method rowHeight =
     (get_float (Objc.invoke Objc.tag_float o (Selector.find "rowHeight:")[]) : float)
   method noteHeightOfRowsWithIndexesChanged (indexSet : [`NSIndexSet] Objc.t) =
     (get_unit (Objc.invoke Objc.tag_unit o (Selector.find "noteHeightOfRowsWithIndexesChanged:")[make_pointer_from_object indexSet]) : unit)
   method tableColumns =
     (get_pointer (Objc.invoke Objc.tag_pointer o (Selector.find "tableColumns:")[]) : [`NSArray] Objc.nativeNSObject)
   ...
   method addTableColumn (column : [`NSTableColumn] Objc.t) =
     (get_unit (Objc.invoke Objc.tag_unit o (Selector.find "addTableColumn:")[make_pointer_from_object column]) : unit)
   method removeTableColumn (column : [`NSTableColumn] Objc.t) =
     (get_unit (Objc.invoke Objc.tag_unit o (Selector.find "removeTableColumn:")[make_pointer_from_object column]) : unit)
   method columnWithIdentifier (identifier : [`NSObject] Objc.t) =
     (get_int (Objc.invoke Objc.tag_int o (Selector.find "columnWithIdentifier:")[make_pointer_from_object identifier]) : int)
   method tableColumnWithIdentifier (identifier : [`NSObject] Objc.t) =
     (get_pointer (Objc.invoke Objc.tag_pointer o (Selector.find "tableColumnWithIdentifier:")[make_pointer_from_object identifier]) : [`NSTableColumn] Objc.nativeNSObject)
   method tile =
   ...
   method sizeLastColumnToFit =
     (get_unit (Objc.invoke Objc.tag_unit o (Selector.find "sizeLastColumnToFit:")[]) : unit)
   method scrollRowToVisible (row : int) =
     (get_unit (Objc.invoke Objc.tag_unit o (Selector.find "scrollRowToVisible:")[make_int row]) : unit)
   ...
   method noteNumberOfRowsChanged =
     (get_unit (Objc.invoke Objc.tag_unit o (Selector.find "noteNumberOfRowsChanged:")[]) : unit)
   method editedColumn =
     (get_int (Objc.invoke Objc.tag_int o (Selector.find "editedColumn:")[]) : int)
   method editedRow =
     (get_int (Objc.invoke Objc.tag_int o (Selector.find "editedRow:")[]) : int)
   method clickedColumn =
     (get_int (Objc.invoke Objc.tag_int o (Selector.find "clickedColumn:")[]) : int)
   method clickedRow =
     (get_int (Objc.invoke Objc.tag_int o (Selector.find "clickedRow:")[]) : int)
   ...
   method setSortDescriptors (array : [`NSArray] Objc.t) =
     (get_unit (Objc.invoke Objc.tag_unit o (Selector.find "setSortDescriptors:")[make_pointer_from_object array]) : unit)
   ...
   method indicatorImageInTableColumn (tc : [`NSTableColumn] Objc.t) =
     (get_pointer (Objc.invoke Objc.tag_pointer o (Selector.find "indicatorImageInTableColumn:")[make_pointer_from_object tc]) : [`NSImage] Objc.nativeNSObject)
   method setHighlightedTableColumn (tc : [`NSTableColumn] Objc.t) =
     (get_unit (Objc.invoke Objc.tag_unit o (Selector.find "setHighlightedTableColumn:")[make_pointer_from_object tc]) : unit)
   method highlightedTableColumn =
     (get_pointer (Objc.invoke Objc.tag_pointer o (Selector.find "highlightedTableColumn:")[]) : [`NSTableColumn] Objc.nativeNSObject)
   method setVerticalMotionCanBeginDrag (flag : bool) =
     (get_unit (Objc.invoke Objc.tag_unit o (Selector.find "setVerticalMotionCanBeginDrag:")[make_bool flag]) : unit)
   method verticalMotionCanBeginDrag =
     (get_bool (Objc.invoke Objc.tag_bool o (Selector.find "verticalMotionCanBeginDrag:")[]) : bool)
(*  UNSUPPORTED
...
*)
   ...
   method setAllowsColumnSelection (flag : bool) =
     (get_unit (Objc.invoke Objc.tag_unit o (Selector.find "setAllowsColumnSelection:")[make_bool flag]) : unit)
   method allowsColumnSelection =
     (get_bool (Objc.invoke Objc.tag_bool o (Selector.find "allowsColumnSelection:")[]) : bool)
   ...
   method deselectAll (sender : [`NSObject] Objc.t) =
     (get_unit (Objc.invoke Objc.tag_unit o (Selector.find "deselectAll:")[make_pointer_from_object sender]) : unit)
   ...
   method selectedColumnIndexes =
     (get_pointer (Objc.invoke Objc.tag_pointer o (Selector.find "selectedColumnIndexes:")[]) : [`NSIndexSet] Objc.nativeNSObject)
   method selectedRowIndexes =
     (get_pointer (Objc.invoke Objc.tag_pointer o (Selector.find "selectedRowIndexes:")[]) : [`NSIndexSet] Objc.nativeNSObject)
   method deselectColumn (column : int) =
     (get_unit (Objc.invoke Objc.tag_unit o (Selector.find "deselectColumn:")[make_int column]) : unit)
   method deselectRow (row : int) =
     (get_unit (Objc.invoke Objc.tag_unit o (Selector.find "deselectRow:")[make_int row]) : unit)
   ...
   method isColumnSelected (row : int) =
     (get_bool (Objc.invoke Objc.tag_bool o (Selector.find "isColumnSelected:")[make_int row]) : bool)
   method isRowSelected (row : int) =
     (get_bool (Objc.invoke Objc.tag_bool o (Selector.find "isRowSelected:")[make_int row]) : bool)
   method numberOfSelectedColumns =
     (get_int (Objc.invoke Objc.tag_int o (Selector.find "numberOfSelectedColumns:")[]) : int)
   method numberOfSelectedRows =
     (get_int (Objc.invoke Objc.tag_int o (Selector.find "numberOfSelectedRows:")[]) : int)
(*  UNSUPPORTED
   method rectOfColumn (column : int) =
     ((*NSRect*) unsupported (Objc.invoke (*NSRect*) Objc.tag_unsupported o (Selector.find "rectOfColumn:")[make_int column]) : (*NSRect*) unsupported)

*)
(*  UNSUPPORTED
   method rectOfRow (row : int) =
     ((*NSRect*) unsupported (Objc.invoke (*NSRect*) Objc.tag_unsupported o (Selector.find "rectOfRow:")[make_int row]) : (*NSRect*) unsupported)

*)
(*  UNSUPPORTED
   method columnsInRect (rect : (*NSRect*) unsupported) =
     (get_range (Objc.invoke Objc.tag_nsrange o (Selector.find "columnsInRect:")[(*NSRect*) unsupported rect]) : (int * int))

*)
(*  UNSUPPORTED
   method rowsInRect (rect : (*NSRect*) unsupported) =
     (get_range (Objc.invoke Objc.tag_nsrange o (Selector.find "rowsInRect:")[(*NSRect*) unsupported rect]) : (int * int))
...
(*  UNSUPPORTED
   method rowAtPoint (point : (*NSPoint*) unsupported) =
     (get_int (Objc.invoke Objc.tag_int o (Selector.find "rowAtPoint:")[(*NSPoint*) unsupported point]) : int)
...
*)
   ...
   method setAutosaveName (name : [`NSString] Objc.t) =
     (get_unit (Objc.invoke Objc.tag_unit o (Selector.find "setAutosaveName:")[make_pointer_from_object name]) : unit)
   method autosaveName =
     (get_pointer (Objc.invoke Objc.tag_pointer o (Selector.find "autosaveName:")[]) : [`NSString] Objc.nativeNSObject)
   method setAutosaveTableColumns (save : bool) =
     (get_unit (Objc.invoke Objc.tag_unit o (Selector.find "setAutosaveTableColumns:")[make_bool save]) : unit)
   method autosaveTableColumns =
     (get_bool (Objc.invoke Objc.tag_bool o (Selector.find "autosaveTableColumns:")[]) : bool)
...
(*  UNSUPPORTED
   method highlightSelectionInClipRect (rect : (*NSRect*) unsupported) =
     (get_unit (Objc.invoke Objc.tag_unit o (Selector.find "highlightSelectionInClipRect:")[(*NSRect*) unsupported rect]) : unit)

*)
(*  UNSUPPORTED
   method drawGridInClipRect (rect : (*NSRect*) unsupported) =
     (get_unit (Objc.invoke Objc.tag_unit o (Selector.find "drawGridInClipRect:")[(*NSRect*) unsupported rect]) : unit)

*)
(*  UNSUPPORTED
   method drawBackgroundInClipRect (clipRect : (*NSRect*) unsupported) =
     (get_unit (Objc.invoke Objc.tag_unit o (Selector.find "drawBackgroundInClipRect:")[(*NSRect*) unsupported clipRect]) : unit)

*)
   method setDrawsGrid (flag : bool) =
     (get_unit (Objc.invoke Objc.tag_unit o (Selector.find "setDrawsGrid:")[make_bool flag]) : unit)
   method drawsGrid =
     (get_bool (Objc.invoke Objc.tag_bool o (Selector.find "drawsGrid:")[]) : bool)
   ...
   method selectedColumnEnumerator =
     (get_pointer (Objc.invoke Objc.tag_pointer o (Selector.find "selectedColumnEnumerator:")[]) : [`NSEnumerator] Objc.nativeNSObject)
   method selectedRowEnumerator =
     (get_pointer (Objc.invoke Objc.tag_pointer o (Selector.find "selectedRowEnumerator:")[]) : [`NSEnumerator] Objc.nativeNSObject)
(*  UNSUPPORTED
...
*)
   method setAutoresizesAllColumnsToFit (flag : bool) =
     (get_unit (Objc.invoke Objc.tag_unit o (Selector.find "setAutoresizesAllColumnsToFit:")[make_bool flag]) : unit)
   method autoresizesAllColumnsToFit =
     (get_bool (Objc.invoke Objc.tag_bool o (Selector.find "autoresizesAllColumnsToFit:")[]) : bool)
end
...
(* methods for category NSTableDataSource *)
   method numberOfRowsInTableView (tableView : [`NSTableView] Objc.t) =
     (get_int (Objc.invoke Objc.tag_int o (Selector.find "numberOfRowsInTableView:")[make_pointer_from_object tableView]) : int)
...
(* methods for category NSTableViewNotifications *)
   method tableViewSelectionDidChange (notification : [`NSNotification] Objc.t) =
     (get_unit (Objc.invoke Objc.tag_unit o (Selector.find "tableViewSelectionDidChange:")[make_pointer_from_object notification]) : unit)
   method tableViewColumnDidMove (notification : [`NSNotification] Objc.t) =
     (get_unit (Objc.invoke Objc.tag_unit o (Selector.find "tableViewColumnDidMove:")[make_pointer_from_object notification]) : unit)
   method tableViewColumnDidResize (notification : [`NSNotification] Objc.t) =
     (get_unit (Objc.invoke Objc.tag_unit o (Selector.find "tableViewColumnDidResize:")[make_pointer_from_object notification]) : unit)
   method tableViewSelectionIsChanging (notification : [`NSNotification] Objc.t) =
     (get_unit (Objc.invoke Objc.tag_unit o (Selector.find "tableViewSelectionIsChanging:")[make_pointer_from_object notification]) : unit)
(* methods for category NSTableViewDelegate *)
   ...
   method selectionShouldChangeInTableView (aTableView : [`NSTableView] Objc.t) =
     (get_bool (Objc.invoke Objc.tag_bool o (Selector.find "selectionShouldChangeInTableView:")[make_pointer_from_object aTableView]) : bool)
