...
let _ = init()
let make_NSTextFieldCell_of_NSComboBoxCell (o : [`NSComboBoxCell] nativeNSObject) = (Obj.magic o : [`NSTextFieldCell] nativeNSObject)
(* Class object for NSComboBoxCell *)
let class_NSComboBoxCell = object
   val repr = Classes.find "NSComboBoxCell"
   method _new = (Objc.objcnew repr : [`NSComboBoxCell] nativeNSObject)
   method _alloc = (Objc.objcalloc repr : [`NSComboBoxCell] nativeNSObject)
end
...
class native_NSComboBoxCell = fun (o : [`NSComboBoxCell] nativeNSObject) -> object (self)
   inherit native_NSTextFieldCell (make_NSTextFieldCell_of_NSComboBoxCell o) as super
...
*)
   ...
   method completedString (string : [`NSString] Objc.t) =
     (get_pointer (Objc.invoke Objc.tag_pointer repr (Selector.find "completedString:")[make_pointer_from_object string]) : [`NSString] Objc.nativeNSObject)
   method dataSource =
...
(* methods for category NSComboBoxCellDataSource *)
   method numberOfItemsInComboBoxCell (comboBoxCell : [`NSComboBoxCell] Objc.t) =
     (get_int (Objc.invoke Objc.tag_int repr (Selector.find "numberOfItemsInComboBoxCell:")[make_pointer_from_object comboBoxCell]) : int)
